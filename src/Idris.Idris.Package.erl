										...
										fun (V75) ->
											begin
											  ...
											  case V101 of
												...
												fun (V103) ->
													begin
													  V129 = ('nested--20153-6325--in--un--loadDependencies'(V0, V1, V2,
																				 case V16 of
																					  ...
																					  fun (V114) ->
																						  begin
																						    ...
																						    case V140 of
																							  ...
																							  fun (V142) ->
																								  begin
																								    V168 = ('nested--20153-6325--in--un--loadDependencies'(V0, V1, V2,
																															   case V55 of
	  ...
	  fun (V9) ->
		  begin
			...
			begin
			  ...
			  fun (V64) ->
				  begin
				    V88 = 'un--foldWithKeysC'(erased, erased, {'Idris.Prelude.dn--un--__mkMonoid', fun (V65) -> fun (V66) -> 'dn--un--<+>_Semigroup__(|Unit,MkUnit|)'(V65, V66) end end, 'dn--un--neutral_Monoid__(|Unit,MkUnit|)'()}, fun (V67) -> fun (V68) -> 'nested--18545-4842--in--un--deleteFolder'(V0, V1, V2, V3, V55, V67, V68) end end,
							      fun (V69) ->
								      fun (V70) ->
									      fun (V71) ->
										      'Idris.Prelude':'dn--un--map_Functor__IO'(erased, erased,
																...
																'Idris.Core.Core':'un--traverse'(erased, erased, fun (V87) -> 'nested--18545-4843--in--un--deleteBin'(V0, V1, V2, V3, V55, V69, V87) end, V70), V71)
									      end
								      end
							      end,
							      V63, V64),
				    case V88 of
					  ...
					  fun (V90) ->
						  begin
						    V91 = 'nested--18545-4842--in--un--deleteFolder'(V0, V1, V2, V3, V55, [], V64),
						    case V91 of
						      {'Idris.Prelude.Left', E49} -> fun (V92) -> {'Idris.Prelude.Left', V92} end(E49);
						      {'Idris.Prelude.Right', E50} ->
							  fun (V93) ->
								  begin
								    V122 = ('Idris.Prelude':'un--maybe'(erased, erased, fun () -> fun (V94) -> {'Idris.Prelude.Right', {'Idris.Builtin.MkUnit'}} end end, fun () -> fun (V95) -> fun (V96) -> 'nested--18545-4841--in--un--delete'(V0, V1, V2, V3, 'Idris.Utils.Path':'un--</>'(V56, V95), V96) end end end,
													case V1 of
    ...
    case V9 of
	  ...
	  fun (V10, V11) ->
		  begin
		    ...
		    fun (V13) ->
			    begin
			      V14 = 'nested--18424-4729--in--un--go'(erased, V1, erased, V3, V4, V12, V11, V13),
			      case V14 of
...
'nested--16950-3344--in--un--toSource'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V4, V5) ->
		  fun (V6) ->
													...
													{'Idris.Builtin.MkPair', E2, E3} ->
													    fun (V24, V25) ->
														    begin
														      ...
														      fun (V27) ->
															      begin
																V28 = 'nested--18424-4729--in--un--go'(erased, V1, erased, V3, V4, V26, V25, V27),
																case V28 of
...
'nested--16950-3345--in--un--go'(V0, V1, V2, V3, V4, V5, V6) ->
    case V5 of
		  ...
		  fun (V10) ->
			  begin
			    ...
			    case V11 of
			      ...
			      {'Idris.Prelude.Right', E3} -> fun (V13) -> ('nested--16950-3345--in--un--go'(V0, V1, V2, V3, V4, V9, V13))(V10) end(E3);
			      _ -> erlang:throw("Error: Unreachable branch")
			    end
			  end
		  end
...
'nested--18545-4842--in--un--deleteFolder'(V0, V1, V2, V3, V4, V5, V6) -> 'nested--18545-4841--in--un--delete'(V0, V1, V2, V3, 'Idris.Utils.Path':'un--</>'(V4, 'Idris.Utils.Path':'un--joinPath'(V5)), V6).

'nested--18545-4843--in--un--deleteBin'(V0, V1, V2, V3, V4, V5, V6) ->
    begin
      V7 = 'Idris.Utils.Path':'un--</>'(V4, 'Idris.Utils.Path':'un--</>'('Idris.Utils.Path':'un--joinPath'(V5), V6)),
      fun (V8) ->
	      begin
		V9 = 'nested--18545-4841--in--un--delete'(V0, V1, V2, V3, 'Idris.Utils.Path':'un--<.>'(V7, <<"ttc"/utf8>>), V8),
		case V9 of
		  {'Idris.Prelude.Left', E0} -> fun (V10) -> {'Idris.Prelude.Left', V10} end(E0);
		  {'Idris.Prelude.Right', E1} -> fun (V11) -> 'nested--18545-4841--in--un--delete'(V0, V1, V2, V3, 'Idris.Utils.Path':'un--<.>'(V7, <<"ttm"/utf8>>), V8) end(E1);
		  _ -> erlang:throw("Error: Unreachable branch")
		end
	      end
      end
...
'nested--18545-4841--in--un--delete'(V0, V1, V2, V3, V4, V5) ->
    begin
...
'un--foldWithKeysC'(V0, V1, V2, V3, V4, V5, V6) -> 'nested--18424-4729--in--un--go'(erased, V2, erased, V4, V3, [], V5, V6).
																						  ...
																						  fun (V117) ->
																							  begin
																							    ...
																							    case V143 of
																								  ...
																								  fun (V145) ->
																									  begin
																									    V171 = ('nested--20153-6325--in--un--loadDependencies'(V2, V1, V0,
																																   case V58 of
...
'un--field'(V0) ->
    {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V1) -> fun (V2) -> {'Idris.Idris.Package.PVersion', V1, V2} end end, <<"version"/utf8>>),
     fun () ->
	     {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V3) -> fun (V4) -> {'Idris.Idris.Package.PAuthors', V3, V4} end end, <<"authors"/utf8>>),
	      fun () ->
		      {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V5) -> fun (V6) -> {'Idris.Idris.Package.PMaintainers', V5, V6} end end, <<"maintainers"/utf8>>),
		       fun () ->
			       {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V7) -> fun (V8) -> {'Idris.Idris.Package.PLicense', V7, V8} end end, <<"license"/utf8>>),
				fun () ->
					{'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V9) -> fun (V10) -> {'Idris.Idris.Package.PBrief', V9, V10} end end, <<"brief"/utf8>>),
					 fun () ->
						 {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V11) -> fun (V12) -> {'Idris.Idris.Package.PReadMe', V11, V12} end end, <<"readme"/utf8>>),
						  fun () ->
							  {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V13) -> fun (V14) -> {'Idris.Idris.Package.PHomePage', V13, V14} end end, <<"homepage"/utf8>>),
							   fun () ->
								   {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V15) -> fun (V16) -> {'Idris.Idris.Package.PSourceLoc', V15, V16} end end, <<"sourceloc"/utf8>>),
								    fun () ->
									    {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V17) -> fun (V18) -> {'Idris.Idris.Package.PBugTracker', V17, V18} end end, <<"bugtracker"/utf8>>),
									     fun () ->
										     {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V19) -> fun (V20) -> {'Idris.Idris.Package.POpts', V19, V20} end end, <<"options"/utf8>>),
										      fun () ->
											      {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V21) -> fun (V22) -> {'Idris.Idris.Package.POpts', V21, V22} end end, <<"opts"/utf8>>),
											       fun () ->
												       {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V23) -> fun (V24) -> {'Idris.Idris.Package.PSourceDir', V23, V24} end end, <<"sourcedir"/utf8>>),
													fun () ->
														{'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V25) -> fun (V26) -> {'Idris.Idris.Package.PBuildDir', V25, V26} end end, <<"builddir"/utf8>>),
														 fun () ->
															 {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V27) -> fun (V28) -> {'Idris.Idris.Package.POutputDir', V27, V28} end end, <<"outputdir"/utf8>>),
															  fun () ->
																  {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V29) -> fun (V30) -> {'Idris.Idris.Package.PPrebuild', V29, V30} end end, <<"prebuild"/utf8>>),
																   fun () ->
																	   {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V31) -> fun (V32) -> {'Idris.Idris.Package.PPostbuild', V31, V32} end end, <<"postbuild"/utf8>>),
																	    fun () ->
																		    {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V33) -> fun (V34) -> {'Idris.Idris.Package.PPreinstall', V33, V34} end end, <<"preinstall"/utf8>>),
																		     fun () ->
																			     {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V35) -> fun (V36) -> {'Idris.Idris.Package.PPostinstall', V35, V36} end end, <<"postinstall"/utf8>>),
																			      fun () ->
																				      {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V37) -> fun (V38) -> {'Idris.Idris.Package.PPreclean', V37, V38} end end, <<"preclean"/utf8>>),
																				       fun () ->
																					       {'Idris.Text.Parser.Core.Alt', 0, 0, 'nested--15345-1770--in--un--strField'(V0, fun (V39) -> fun (V40) -> {'Idris.Idris.Package.PPostclean', V39, V40} end end, <<"postclean"/utf8>>),
																						fun () ->
									...
									begin
									  ...
									  begin
									    ...
									    begin
									      ...
									      begin
										V256 = 'un--foldWithKeysC'(erased, erased, {'Idris.Prelude.dn--un--__mkMonoid', fun (V233) -> fun (V234) -> 'dn--un--<+>_Semigroup__(|Unit,MkUnit|)'(V233, V234) end end, 'dn--un--neutral_Monoid__(|Unit,MkUnit|)'()}, fun (V235) -> fun (V236) -> 'nested--18545-4842--in--un--deleteFolder'(V3, V2, V1, V0, V224, V235, V236) end end,
													   fun (V237) ->
														   fun (V238) ->
															   fun (V239) ->
																   'Idris.Prelude':'dn--un--map_Functor__IO'(erased, erased,
																					     ...
																					     'Idris.Core.Core':'un--traverse'(erased, erased, fun (V255) -> 'nested--18545-4843--in--un--deleteBin'(V3, V2, V1, V0, V224, V237, V255) end, V238), V239)
															   end
														   end
													   end,
													   V232, V4),
										case V256 of
										  ...
										  {'Idris.Prelude.Right', E156} ->
										      fun (V258) ->
											      begin
												V259 = 'nested--18545-4842--in--un--deleteFolder'(V3, V2, V1, V0, V224, [], V4),
												case V259 of
												  {'Idris.Prelude.Left', E157} -> fun (V260) -> {'Idris.Prelude.Left', V260} end(E157);
												  {'Idris.Prelude.Right', E158} ->
												      fun (V261) ->
													      begin
														V290 = ('Idris.Prelude':'un--maybe'(erased, erased, fun () -> fun (V262) -> {'Idris.Prelude.Right', {'Idris.Builtin.MkUnit'}} end end, fun () -> fun (V263) -> fun (V264) -> 'nested--18545-4841--in--un--delete'(V3, V2, V1, V0, 'Idris.Utils.Path':'un--</>'(V225, V263), V264) end end end,
																		    case V2 of
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V6) ->
			...
			{'Idris.Prelude.Right', E3} ->
			    fun (V9) ->
				    begin
				      V10 = ('nested--16950-3345--in--un--go'(V2, V1, V0, V6, V9, V1, V2))(V3),
				      case V10 of
									...
									{'Idris.Prelude.Right', E34} ->
									    fun (V71) ->
											...
											{'Idris.Prelude.Right', E36} ->
											    fun (V102) ->
												    begin
												      V104 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V103) -> 'nested--16950-3344--in--un--toSource'(V2, V1, V0, V103) end, V71))(V3),
												      case V104 of
													{'Idris.Prelude.Left', E37} -> fun (V105) -> {'Idris.Prelude.Left', V105} end(E37);
													{'Idris.Prelude.Right', E38} ->
													    fun (V106) ->
														    begin
														      V108 = ('Idris.Core.Core':'un--traverseOpt'(erased, erased, fun (V107) -> 'nested--16950-3344--in--un--toSource'(V2, V1, V0, V107) end, V102))(V3),
														      case V108 of
