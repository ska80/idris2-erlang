...
'case--getIDECommand-2753'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Prelude.Just', E0} -> fun (V5) -> {'Idris.Prelude.Just', {'Idris.Idris.IDEMode.Commands.ExprSearch', V0, V1, V5, 'nested--2515-2744--in--un--getMode'(V0, V1, V2, V3, V3)}} end(E0);
      _ -> {'Idris.Prelude.Nothing'}
    end.

'case--getIDECommand-2704'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Prelude.Just', E0} -> fun (V4) -> {'Idris.Prelude.Just', {'Idris.Idris.IDEMode.Commands.ExprSearch', V0, V1, V4, 1}} end(E0);
      _ -> {'Idris.Prelude.Nothing'}
    end.

'nested--3049-3147--in--un--getMode'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'nested--2515-2744--in--un--getMode'(V0, V1, V2, V3, V4) -> 'Idris.Prelude':'dn--un--==_Eq__String'(V4, <<"all"/utf8>>).

'nested--3409-3389--in--un--escapeChar'(V0) ->
    case V0 of
      $\\ -> [$\\, $\\];
      $" -> [$\\, $"];
      _ -> [V0]
...
'dn--un--toSExp_SExpable__(|((Builtin.Pair $a) $b),((Builtin.MkPair $a) $b)|)'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Builtin.MkPair', E0, E1} -> fun (V4, V5) -> 'case--toSExp-3588'(erased, erased, V2, V4, V5, ('Idris.Builtin':'un--snd'(erased, erased, V2))(V5)) end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
...
'un--getIDECommand'(V0) ->
    case V0 of
													    ...
													    case V49 of
														  ...
														  fun (V51, V52) ->
															  case V51 of
																...
																fun (V53) ->
																	case V52 of
																	  [] -> 'case--getIDECommand-2704'(V47, V50, V53, 'un--readHints'(V53));
																	  [E53 | E54] ->
																	      fun (V54, V55) ->
																		      case V54 of
																			{'Idris.Idris.IDEMode.Commands.SymbolAtom', E55} ->
																			    fun (V56) ->
																				    case V55 of
																				      [] -> 'case--getIDECommand-2753'(V47, V50, V53, V56, 'un--readHints'(V53));
																				      _ -> {'Idris.Prelude.Nothing'}
																				    end
																			    end(E55);
																			_ -> {'Idris.Prelude.Nothing'}
																 ...
																 fun (V84, V85) ->
																	 case V84 of
																	   {'Idris.Idris.IDEMode.Commands.SymbolAtom', E85} ->
																	       fun (V86) ->
																		       case unicode:characters_to_binary(V86) of
																			 <<"overview"/utf8>> ->
																			     case V85 of
																			       [] -> {'Idris.Prelude.Just', {'Idris.Prelude.Just', {'Idris.Idris.IDEMode.Commands.Overview'}}};
																			       _ -> {'Idris.Prelude.Nothing'}
	  ...
	  fun (V121) ->
		  case unicode:characters_to_binary(V121) of
