...
-export(['case--preOptions-2017'/5, 'case--preOptions-1972'/5, 'case--preOptions-1927'/5, 'case--preOptions-1882'/5, 'case--preOptions-1837'/5, 'case--preOptions-1796'/4, 'case--preOptions-1751'/6, 'case--preOptions-1537'/6, 'case--preOptions-1515'/4, 'case--preOptions-1462'/4, 'case--preOptions-1421'/4, 'case--preOptions-1378'/5, 'case--preOptions-1333'/5, 'case--preOptions-1290'/4, 'un--preOptions'/3, 'un--postOptions'/6, 'un--ideModeSocket'/1, 'un--ideMode'/1, 'un--dirOption'/2]).

'case--preOptions-2017'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--preOptions-1972'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--preOptions-1927'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--preOptions-1882'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--preOptions-1837'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--preOptions-1796'(V0, V1, V2, V3) ->
    case V3 of
...
'case--preOptions-1751'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--preOptions-1537'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--preOptions-1515'(V0, V1, V2, V3) ->
    case V3 of
...
'case--preOptions-1462'(V0, V1, V2, V3) ->
    case V3 of
...
'case--preOptions-1421'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Core.Options.MkSessionOpts', E0, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12} -> fun (V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16) -> {'Idris.Core.Options.MkSessionOpts', V4, 0, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16} end(E0, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--preOptions-1378'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--preOptions-1333'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Core.Options.MkSessionOpts', E0, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12} -> fun (V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17) -> {'Idris.Core.Options.MkSessionOpts', V5, 0, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17} end(E0, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--preOptions-1290'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Core.Options.MkSessionOpts', E0, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12} -> fun (V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16) -> {'Idris.Core.Options.MkSessionOpts', V4, 0, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16} end(E0, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
				...
				fun (V133) ->
					begin
					  ...
					  case V162 of
						...
						fun (V164) ->
							('case--preOptions-1537'(V132, V5, V1, V0, V164,
