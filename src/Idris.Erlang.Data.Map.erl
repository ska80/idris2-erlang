...
-export(['case--get-1009'/8, 'case--entries-913'/4, 'un--values'/2, 'un--toAnyMap'/2, 'un--size'/2, 'un--lookup'/7, 'un--keys'/2, 'un--insert'/6, 'un--get'/6, 'un--entries'/2, 'un--empty'/0, 'un--delete'/4]).

'case--get-1009'(V0, V1, V2, V3, V4, V5, V6, V7) -> V6.

'case--entries-913'(V0, V1, V2, V3) ->
    case V3 of
