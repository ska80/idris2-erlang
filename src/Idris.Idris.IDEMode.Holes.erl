...
-export(['case--showHole-3507'/10, 'case--case block in holeData-3467'/10, 'case--holeData-3418'/11, 'case--holeData,dropShadows-3357'/11, 'case--case block in extractHoleData-3243'/14, 'case--extractHoleData-3191'/13, 'case--case block in isHole-3031'/7, 'case--isHole-3010'/2, 'nested--8646-3137--in--un--implicitBind'/12, 'nested--8891-3335--in--un--dropShadows'/9, 'un--tidy'/1, 'un--showName'/1, 'un--showHole'/9, 'un--showCount'/1, 'un--sexpPremise'/1, 'un--sexpHole'/1, 'un--isHole'/1, 'un--impBracket'/2, 'un--holeData'/9, 'un--extractHoleData'/8]).

'case--showHole-3507'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      [] ->
	  fun (V10) ->
		  {'Idris.Prelude.Right',
...
'case--case block in holeData-3467'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V8 of
      {'Idris.Idris.IDEMode.Holes.MkHoleData', E0, E1, E2} -> fun (V10, V11, V12) -> {'Idris.Idris.IDEMode.Holes.MkHoleData', V10, V11, 'nested--8891-3335--in--un--dropShadows'(V0, V1, V2, V3, V4, V5, V6, V7, V12)} end(E0, E1, E2);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--holeData-3418'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      0 -> V8;
      1 ->
	  case V8 of
	    {'Idris.Idris.IDEMode.Holes.MkHoleData', E0, E1, E2} -> fun (V11, V12, V13) -> {'Idris.Idris.IDEMode.Holes.MkHoleData', V11, V12, 'nested--8891-3335--in--un--dropShadows'(V0, V1, V2, V3, V4, V5, V6, V7, V13)} end(E0, E1, E2);
	    _ -> erlang:throw("Error: Unreachable branch")
	  end;
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--holeData,dropShadows-3357'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      0 -> 'nested--8891-3335--in--un--dropShadows'(V0, V1, V2, V3, V4, V5, V6, V7, V9);
      1 -> [V8 | 'nested--8891-3335--in--un--dropShadows'(V0, V1, V2, V3, V4, V5, V6, V7, V9)];
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--case block in extractHoleData-3243'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13) ->
    case V11 of
...
'case--extractHoleData-3191'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12) ->
    case V12 of
      0 ->
	  fun (V13) ->
		  begin
		    ...
		    case V17 of
			  ...
			  fun (V19) ->
				  begin
				    V20 = {'Idris.Idris.IDEMode.Holes.MkHolePremise', V2, V19, 'Idris.Core.TT':'un--multiplicity'(erased, V4), 'nested--8646-3137--in--un--implicitBind'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V4)},
				    {'Idris.Prelude.Right',
				     case V11 of
...
'case--case block in isHole-3031'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'nested--8646-3137--in--un--implicitBind'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11) ->
    case V11 of
...
'nested--8891-3335--in--un--dropShadows'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
      [] -> [];
      [E0 | E1] ->
	  fun (V9, V10) ->
		  'case--holeData,dropShadows-3357'(V0, V1, V2, V3, V4, V5, V6, V7, V9, V10,
...
'un--showHole'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V11) ->
		    ('case--showHole-3507'(V0, V7, V6, V5, V4, V3, V2, V1, V11,
					   case V11 of
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V11) ->
			...
			{'Idris.Prelude.Right', E3} ->
			    fun (V14) ->
				    {'Idris.Prelude.Right',
				     'case--holeData-3418'(V0, V7, V6, V5, V4, V3, V2, V1, V11, V14,
							   case V14 of
				...
				fun (V23) ->
					begin
					  ...
					  case V24 of
					    ...
					    {'Idris.Prelude.Right', E9} -> fun (V26) -> ('case--extractHoleData-3191'(V0, V15, V17, V19, V18, V16, V5, V4, V3, V2, V1, V26, 'un--showName'(V17)))(V23) end(E9);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end
					end
				end
