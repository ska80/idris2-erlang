	  ...
	  fun (V12) ->
		  case V12 of
			...
			fun (V13, V14) ->
				fun (V15) ->
					begin
					  V16 = 'nested--19385-5949--in--un--updateOutput'(V0, V1, V2, V3, V4, V14, V15),
					  case V16 of
...
'nested--18997-5768--in--un--versionSExp'(V0, V1, V2, V3, V4, V5, V6, V7) -> {'Idris.Idris.IDEMode.Commands.SExpList', ['nested--18997-5766--in--un--semverSexp'(V0, V1, V2, V3, V4, V5, V6, V7), 'nested--18997-5767--in--un--tagSexp'(V0, V1, V2, V3, V4, V5, V6, V7)]}.

'nested--19385-5949--in--un--updateOutput'(V0, V1, V2, V3, V4, V5, V6) ->
    begin
...
'nested--18997-5767--in--un--tagSexp'(V0, V1, V2, V3, V4, V5, V6, V7) ->
...
'nested--18997-5766--in--un--semverSexp'(V0, V1, V2, V3, V4, V5, V6, V7) ->
...
'nested--18997-5755--in--un--optionsSexp'(V0, V1, V2, V3, V4, V5, V6, V7) -> {'Idris.Idris.IDEMode.Commands.SExpList', 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V8) -> 'dn--un--toSExp_SExpable__REPLOpt'(V8) end, V0)}.
    ...
    case V7 of
	  ...
	  fun (V8) ->
		  case V8 of
		    ...
		    {'Idris.Idris.REPL.OptionsSet', E22} -> fun (V35) -> 'un--printIDEResult'(V5, V6, 'nested--18997-5755--in--un--optionsSexp'(V35, V6, V5, V4, V3, V2, V1, V0)) end(E22);
		    {'Idris.Idris.REPL.VersionIs', E23} -> fun (V36) -> 'un--printIDEResult'(V5, V6, 'nested--18997-5768--in--un--versionSExp'(V36, V6, V5, V4, V3, V2, V1, V0)) end(E23);
