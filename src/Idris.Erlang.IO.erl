...
'un--prim__erlUnsafeCall'(V0, V1, V2, V3, V4, V5) -> erlang:apply(erlang:binary_to_atom(unicode:characters_to_binary(V2), utf8), erlang:binary_to_atom(unicode:characters_to_binary(V3), utf8), V4).
...
'un--erlUnsafeCall'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V2 of
      {'Idris.Prelude.dn--un--__mkHasIO', E0, E1} -> fun (V9, V10) -> (V10(erased))(fun (V11) -> erlang:apply(erlang:binary_to_atom(unicode:characters_to_binary(V5), utf8), erlang:binary_to_atom(unicode:characters_to_binary(V6), utf8), V7) end) end(E0, E1);
...
'un--erlCall'(V0, V1, V2, V3, V4, V5, V6) -> 'un--erlTryCatch'(erased, erased, V2, fun (V7) -> erlang:apply(erlang:binary_to_atom(unicode:characters_to_binary(V3), utf8), erlang:binary_to_atom(unicode:characters_to_binary(V4), utf8), V5) end).
