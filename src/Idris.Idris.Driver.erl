...
-export(['case--case block in mainWithCodegens-3784'/4, 'case--mainWithCodegens-3767'/3, 'case--case block in case block in stMain-3672'/6, 'case--case block in case block in case block in case block in stMain-3475'/27, 'case--case block in case block in case block in case block in case block in stMain-3332'/32, 'case--case block in case block in case block in case block in case block in case block in case block in case block in stMain-3034'/32, 'case--case block in case block in case block in case block in case block in case block in case block in stMain-2960'/30, 'case--case block in case block in case block in case block in case block in case block in stMain-2828'/30, 'case--case block in case block in case block in case block in case block in stMain-2766'/30, 'case--case block in case block in case block in case block in stMain-2707'/29, 'case--case block in case block in case block in case block in stMain-2599'/26, 'case--case block in case block in case block in case block in stMain-2541'/26, 'case--case block in case block in case block in stMain-2413'/19, 'case--case block in case block in stMain-2330'/17, 'case--case block in case block in stMain-2256'/13, 'case--case block in case block in stMain-2192'/7, 'case--case block in stMain-2170'/4, 'case--stMain-2159'/3, 'case--case block in updateREPLOpts-2037'/4, 'case--updateREPLOpts-2011'/3, 'case--updateEnv-1974'/3, 'case--updateEnv-1934'/5, 'case--updateEnv-1886'/7, 'case--updateEnv-1830'/9, 'case--case block in updateEnv-1742'/13, 'case--updateEnv-1715'/11, 'case--updateEnv-1616'/14, 'case--getPrivDir-1505'/2, 'un--updateREPLOpts'/2, 'un--updateEnv'/2, 'un--tryYaffle'/1, 'un--tryTTM'/1, 'un--stMain'/3, 'un--showInfo'/3, 'un--quitOpts'/1, 'un--mainWithCodegens'/2, 'un--getPrivDir'/1, 'un--findInput'/1, 'un--checkVerbose'/1, 'un--banner'/0]).

'case--case block in mainWithCodegens-3784'(V0, V1, V2, V3) ->
    case V3 of
...
'case--mainWithCodegens-3767'(V0, V1, V2) ->
    case V2 of
...
'case--case block in case block in stMain-3672'(V0, V1, V2, V3, V4, V5) ->
    case V4 of
...
'case--case block in case block in case block in case block in stMain-3475'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26) ->
    case V25 of
...
'case--case block in case block in case block in case block in case block in stMain-3332'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, V29, V30, V31) ->
    case V31 of
...
'case--case block in case block in case block in case block in case block in case block in case block in case block in stMain-3034'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, V29, V30, V31) ->
    case V31 of
...
'case--case block in case block in case block in case block in case block in case block in case block in stMain-2960'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, V29) ->
    case V29 of
...
'case--case block in case block in case block in case block in case block in case block in stMain-2828'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, V29) ->
    case V29 of
      0 ->
	  fun (V30) ->
		  begin
      ...
      1 -> 'case--case block in case block in case block in case block in case block in case block in case block in stMain-2960'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, 'Idris.Idris.CommandLine':'un--ideSocketModeAddress'(V0));
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--case block in case block in case block in case block in case block in stMain-2766'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, V29) ->
    case V29 of
      0 -> 'case--case block in case block in case block in case block in case block in case block in stMain-2828'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28, 'Idris.Prelude':'un--not'(V12));
      1 ->
	  fun (V30) ->
		  begin
...
'case--case block in case block in case block in case block in stMain-2707'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V28) ->
    case V28 of
      0 -> begin V29 = 0, 'case--case block in case block in case block in case block in case block in stMain-2766'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V29, 'Idris.Prelude':'un--||'(V11, fun () -> V12 end)) end;
      1 ->
	  fun (V30) ->
		  begin
				  ...
				  begin
				    ...
				    case V62 of
					  ...
					  fun (V64) ->
						  begin
						    V65 = 1,
						    ('case--case block in case block in case block in case block in case block in stMain-3332'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27, V65, V61, V64,
																	       case V61 of
...
'case--case block in case block in case block in case block in stMain-2599'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25) ->
    case V25 of
...
'case--case block in case block in case block in case block in stMain-2541'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18, V19, V20, V21, V22, V23, V24, V25) ->
    case V25 of
      {'Idris.Builtin.MkPair', E0, E1} -> fun (V26, V27) -> 'Idris.Prelude.Strings':'un--++'(V26, <<" "/utf8>>) end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--case block in case block in case block in stMain-2413'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18) ->
    case V18 of
      0 ->
	  fun (V19) ->
		  begin
												    ...
												    case V54 of
													  ...
													  fun (V56) ->
														  begin
														    V71 = begin
															    V57 = 0,
															    ('case--case block in case block in case block in case block in stMain-2599'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V57, V22, V25, V28, V31, V34, V56,
																									 case V34 of
																				    ...
																				    case V100 of
																					  ...
																					  fun (V102) ->
																						  begin
																						    V103 = 0,
																						    case V102 of
																						      0 -> begin V104 = 0, ('case--case block in case block in case block in case block in case block in stMain-2766'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V103, V22, V25, V28, V31, V34, V56, V73, V76, V99, V104, 'Idris.Prelude':'un--||'(V11, fun () -> V12 end)))(V19) end;
																						      1 ->
																							  begin
																									  ...
																									  begin
																									    ...
																									    case V136 of
																										  ...
																										  fun (V138) ->
																											  begin
																											    V139 = 1,
																											    ('case--case block in case block in case block in case block in case block in stMain-3332'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V103, V22, V25, V28, V31, V34, V56, V73, V76, V99, V139, V135, V138,
																																						       case V135 of
...
'case--case block in case block in stMain-2330'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16) ->
    case V16 of
																		  ...
																		  case V60 of
																			...
																			fun (V62) ->
																				begin
																				  V77 = begin
																					  V63 = 0,
																					  ('case--case block in case block in case block in case block in stMain-2599'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V25, V21, V63, V28, V31, V34, V37, V40, V62,
																														       case V40 of
																										  ...
																										  case V106 of
																											...
																											fun (V108) ->
																												begin
																												  V109 = 0,
																												  case V108 of
																												    0 -> begin V110 = 0, ('case--case block in case block in case block in case block in case block in stMain-2766'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V25, V21, V109, V28, V31, V34, V37, V40, V62, V79, V82, V105, V110, 'Idris.Prelude':'un--||'(V11, fun () -> V12 end)))(V18) end;
																												    1 ->
																													begin
																															...
																															begin
																															  ...
																															  case V142 of
																																...
																																fun (V144) ->
																																	begin
																																	  V145 = 1,
																																	  ('case--case block in case block in case block in case block in case block in stMain-3332'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V25, V21, V109, V28, V31, V34, V37, V40, V62, V79, V82, V105, V145, V141, V144,
																																												     case V141 of
...
'case--case block in case block in stMain-2256'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12) ->
    case V11 of
...
'case--case block in case block in stMain-2192'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'case--case block in stMain-2170'(V0, V1, V2, V3) ->
    case V3 of
      1 ->
	  fun (V4) ->
		  begin
																																				    ...
																																				    case V132 of
																																					  ...
																																					  fun (V134) ->
																																						  begin
																																						    V149 = begin
																																							     V135 = 0,
																																							     ('case--case block in case block in case block in case block in stMain-2599'(V0, V1, V2, V90, V7, V38, V67, V70, V73, V76, V79, V80, V81, V82, V83, V86, V97, V93, V135, V100, V103, V106, V109, V112, V134,
																																																	  case V112 of
																																												    ...
																																												    case V178 of
																																													  ...
																																													  fun (V180) ->
																																														  begin
																																														    V181 = 0,
																																														    case V180 of
																																														      0 -> begin V182 = 0, ('case--case block in case block in case block in case block in case block in stMain-2766'(V0, V1, V2, V90, V7, V38, V67, V70, V73, V76, V79, V80, V81, V82, V83, V86, V97, V93, V181, V100, V103, V106, V109, V112, V134, V151, V154, V177, V182, 'Idris.Prelude':'un--||'(V80, fun () -> V81 end)))(V4) end;
																																														      1 ->
																																															  begin
																																																	  ...
																																																	  begin
																																																	    ...
																																																	    case V214 of
																																																		  ...
																																																		  fun (V216) ->
																																																			  begin
																																																			    V217 = 1,
																																																			    ('case--case block in case block in case block in case block in case block in stMain-3332'(V0, V1, V2, V90, V7, V38, V67, V70, V73, V76, V79, V80, V81, V82, V83, V86, V97, V93, V181, V100, V103, V106, V109, V112, V134, V151, V154, V177, V217, V213, V216,
																																																														       case V213 of
																																							    ...
																																							    case V135 of
																																								  ...
																																								  fun (V137) ->
																																									  begin
																																									    V152 = begin
																																										     V138 = 0,
																																										     ('case--case block in case block in case block in case block in stMain-2599'(V0, V1, V7, V93, V10, V41, V70, V73, V76, V79, V82, V83, V84, V85, V86, V89, V100, V96, V138, V103, V106, V109, V112, V115, V137,
																																																				  case V115 of
																																															    ...
																																															    case V181 of
																																																  ...
																																																  fun (V183) ->
																																																	  begin
																																																	    V184 = 0,
																																																	    case V183 of
																																																	      0 -> begin V185 = 0, ('case--case block in case block in case block in case block in case block in stMain-2766'(V0, V1, V7, V93, V10, V41, V70, V73, V76, V79, V82, V83, V84, V85, V86, V89, V100, V96, V184, V103, V106, V109, V112, V115, V137, V154, V157, V180, V185, 'Idris.Prelude':'un--||'(V83, fun () -> V84 end)))(V3) end;
																																																	      1 ->
																																																		  begin
																																																				  ...
																																																				  begin
																																																				    ...
																																																				    case V217 of
																																																					  ...
																																																					  fun (V219) ->
																																																						  begin
																																																						    V220 = 1,
																																																						    ('case--case block in case block in case block in case block in case block in stMain-3332'(V0, V1, V7, V93, V10, V41, V70, V73, V76, V79, V82, V83, V84, V85, V86, V89, V100, V96, V184, V103, V106, V109, V112, V115, V137, V154, V157, V180, V220, V216, V219,
																																																																	       case V216 of
...
'case--case block in updateREPLOpts-2037'(V0, V1, V2, V3) ->
    case V1 of
...
'case--updateREPLOpts-2011'(V0, V1, V2) ->
    case V2 of
...
'case--updateEnv-1974'(V0, V1, V2) ->
    case V2 of
      {'Idris.Prelude.Just', E0} -> fun (V3) -> fun (V4) -> 'Idris.Core.Context':'un--setPrefix'(V0, V3, V4) end end(E0);
      {'Idris.Prelude.Nothing'} -> fun () -> fun (V5) -> 'Idris.Core.Context':'un--setPrefix'(V0, 'Idris.IdrisPaths':'un--yprefix'(), V5) end end();
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--updateEnv-1934'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--updateEnv-1886'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'case--updateEnv-1830'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
...
'case--case block in updateEnv-1742'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12) ->
    case V12 of
...
'case--updateEnv-1715'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V11) ->
		  begin
		    V12 = {'Idris.Prelude.Just', V11},
		    'case--case block in updateEnv-1742'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V11, V12,
...
'case--updateEnv-1616'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13) ->
    case V13 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V14) ->
		  fun (V15) ->
			    ...
			    fun (V63) ->
				    begin
				      V65 = case V63 of
					      ...
					      {'Idris.Prelude.Nothing'} -> fun () -> 'Idris.Core.Context':'un--setPrefix'(V0, 'Idris.IdrisPaths':'un--yprefix'(), V1) end();
					      _ -> erlang:throw("Error: Unreachable branch")
					    end,
				      case V65 of
																				      ...
																				      V244 = case V215 of
																						   ...
																						   fun (V216) ->
																							   begin
																							     ...
																							     ('case--case block in updateEnv-1742'(V0, V32, V63, V67, V98, V106, V137, V145, V176, V184, V216, V217,
																																								    ...
																																								    case V137 of
																																									  ...
																																									  fun (V139) ->
																																										  begin
																																										    V154 = begin
																																											     V140 = 0,
																																											     ('case--case block in case block in case block in case block in stMain-2599'(V1, V0, V9, V95, V12, V43, V72, V75, V78, V81, V84, V85, V86, V87, V88, V91, V102, V98, V140, V105, V108, V111, V114, V117, V139,
																																																					  case V117 of
																																																    ...
																																																    case V183 of
																																																	  ...
																																																	  fun (V185) ->
																																																		  begin
																																																		    V186 = 0,
																																																		    case V185 of
																																																		      0 -> begin V187 = 0, ('case--case block in case block in case block in case block in case block in stMain-2766'(V1, V0, V9, V95, V12, V43, V72, V75, V78, V81, V84, V85, V86, V87, V88, V91, V102, V98, V186, V105, V108, V111, V114, V117, V139, V156, V159, V182, V187, 'Idris.Prelude':'un--||'(V85, fun () -> V86 end)))(V2) end;
																																																		      1 ->
																																																			  begin
																																																					  ...
																																																					  begin
																																																					    ...
																																																					    case V219 of
																																																						  ...
																																																						  fun (V221) ->
																																																							  begin
																																																							    V222 = 1,
																																																							    ('case--case block in case block in case block in case block in case block in stMain-3332'(V1, V0, V9, V95, V12, V43, V72, V75, V78, V81, V84, V85, V86, V87, V88, V91, V102, V98, V186, V105, V108, V111, V114, V117, V139, V156, V159, V182, V222, V218, V221,
																																																																		       case V218 of
...
'un--mainWithCodegens'(V0, V1) -> 'case--mainWithCodegens-3767'(V1, V0, 'Idris.Idris.CommandLine':'un--getOpts'(V1)).
      ...
      'Idris.Erlang.Data.Decode':'un--erlDecodeMay'(erased, erased, {'Idris.Erlang.Data.ETErlTerm'},
						    fun (V2) ->
							    'Idris.Erlang.Data.Decode':'dn--un--map_Functor__ErlDecoder'(erased, erased,
															 ...
															 fun (V5) -> 'Idris.Erlang.Data.Decode':'un--charlist'(V5) end, V2)
						    end,
						    V1)
    end.
