...
-export(['case--build-3506'/7, 'un--writeErlFiles'/8, 'un--writeBeamFiles'/7, 'un--writeAbstrFiles'/6, 'un--build'/6]).

'case--build-3506'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'un--build'(V0, V1, V2, V3, V4, V5) ->
    'case--build-3506'(V5, V4, V3, V2, V1, V0,
		       case V1 of
