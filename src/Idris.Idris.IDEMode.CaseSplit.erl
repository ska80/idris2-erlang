...
-export(['case--case block in case block in getClause-3359'/16, 'case--case block in getClause-3327'/14, 'case--getClause-3268'/7, 'case--case block in fnName-3192'/2, 'case--fnName-3179'/3, 'case--case block in case block in case block in updateCase-3052'/15, 'case--case block in case block in updateCase-2993'/11, 'case--case block in updateCase-2965'/9, 'case--updateCase-2914'/8, 'case--doUpdates-2698'/6, 'case--case block in doUpdates-2600'/6, 'case--doUpdates-2572'/5, 'nested--10953-2524--in--un--spanSpace'/5, 'nested--11703-3209--in--un--indent'/7, 'nested--11337-2885--in--un--getValid'/7, 'nested--11337-2886--in--un--getBad'/7, 'nested--10888-2459--in--un--bracket'/5, 'un--updateCase'/7, 'un--updateAll'/4, 'un--toStrUpdate'/3, 'un--showImpossible'/5, 'un--getReplaces'/5, 'un--getClause'/6, 'un--fnName'/2, 'un--doUpdates'/4]).

'case--case block in case block in getClause-3359'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15) ->
    case V15 of
      {'Idris.Builtin.MkPair', E0, E1} -> fun (V16, V17) -> fun (V18) -> {'Idris.Prelude.Right', {'Idris.Prelude.Just', 'Idris.Prelude.Strings':'un--++'('nested--11703-3209--in--un--indent'(V0, V1, V2, V3, V4, V16, V6), 'Idris.Prelude.Strings':'un--++'('un--fnName'(0, V11), 'Idris.Prelude.Strings':'un--++'(('Idris.Prelude':'un--concat'(erased, erased, {'Idris.Builtin.MkPair', {'Idris.Prelude.dn--un--__mkFoldable', fun (V19) -> fun (V20) -> fun (V21) -> fun (V22) -> fun (V23) -> 'Idris.Prelude':'dn--un--foldr_Foldable__List'(erased, erased, V21, V22, V23) end end end end end, fun (V24) -> fun (V25) -> fun (V26) -> fun (V27) -> fun (V28) -> 'Idris.Prelude':'dn--un--foldl_Foldable__List'(erased, erased, V26, V27, V28) end end end end end}, {'Idris.Prelude.dn--un--__mkMonoid', fun (V29) -> fun (V30) -> 'Idris.Prelude':'dn--un--<+>_Semigroup__String'(V29, V30) end end, 'Idris.Prelude':'dn--un--neutral_Monoid__String'()}}))('Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V31) -> 'Idris.Prelude.Strings':'un--++'(<<" "/utf8>>, V31) end, V12)), 'Idris.Prelude.Strings':'un--++'(<<" = ?"/utf8>>, 'Idris.Prelude.Strings':'un--++'('un--fnName'(1, V11), <<"_rhs"/utf8>>)))))}} end end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--case block in getClause-3327'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13) ->
    case V13 of
      {'Idris.Prelude.Just', E0} -> fun (V14) -> begin V15 = {'Idris.Prelude.Just', V14}, 'case--case block in case block in getClause-3359'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V14, V15, 'Idris.Parser.Unlit':'un--isLitLine'(V14)) end end(E0);
      {'Idris.Prelude.Nothing'} -> fun () -> fun (V16) -> {'Idris.Prelude.Right', {'Idris.Prelude.Nothing'}} end end();
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--getClause-3268'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
													...
													{'Idris.Prelude.Right', E14} ->
													    fun (V26) ->
														    begin
														      ...
														      case V26 of
															{'Idris.Prelude.Just', E15} -> fun (V28) -> begin V29 = {'Idris.Prelude.Just', V28}, ('case--case block in case block in getClause-3359'(V0, V1, V2, V3, V4, V5, V8, V10, V12, V13, V27, V17, V23, V28, V29, 'Idris.Parser.Unlit':'un--isLitLine'(V28)))(V14) end end(E15);
...
'case--case block in fnName-3192'(V0, V1) ->
    case V1 of
...
'case--case block in case block in case block in updateCase-3052'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14) ->
    case V14 of
...
'case--case block in case block in updateCase-2993'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      ...
      {'Idris.Prelude.Just', E0} -> fun (V12) -> begin V14 = 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V13) -> 'nested--11337-2885--in--un--getValid'(V0, V1, V2, V3, V4, V5, V13) end, V2), begin V16 = 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V15) -> 'nested--11337-2886--in--un--getBad'(V0, V1, V2, V3, V4, V5, V15) end, V2), begin V17 = {'Idris.Prelude.Just', V12}, 'case--case block in case block in case block in updateCase-3052'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V12, V17, V14, V16, 'Idris.Data.List':'un--isNil'(erased, V14)) end end end end(E0);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--case block in updateCase-2965'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
	  ...
	  fun (V9) ->
		  begin
			...
			{'Idris.Prelude.Just', E1} -> fun (V13) -> begin V15 = 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V14) -> 'nested--11337-2885--in--un--getValid'(V0, V1, V2, V3, V4, V5, V14) end, V2), begin V17 = 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V16) -> 'nested--11337-2886--in--un--getBad'(V0, V1, V2, V3, V4, V5, V16) end, V2), begin V18 = {'Idris.Prelude.Just', V13}, 'case--case block in case block in case block in updateCase-3052'(V0, V1, V2, V3, V4, V5, V6, V7, V9, V11, V13, V18, V15, V17, 'Idris.Data.List':'un--isNil'(erased, V15)) end end end end(E1);
			_ -> erlang:throw("Error: Unreachable branch")
		      end
		    end
		  end
...
'case--updateCase-2914'(V0, V1, V2, V3, V4, V5, V6, V7) ->
    case V7 of
							...
							begin
							  ...
							  begin
							    ...
							    case V43 of
							      ...
							      {'Idris.Prelude.Just', E4} -> fun (V45) -> begin V47 = 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V46) -> 'nested--11337-2885--in--un--getValid'(V0, V1, V2, V3, V4, V5, V46) end, V2), begin V49 = 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V48) -> 'nested--11337-2886--in--un--getBad'(V0, V1, V2, V3, V4, V5, V48) end, V2), begin V50 = {'Idris.Prelude.Just', V45}, ('case--case block in case block in case block in updateCase-3052'(V0, V1, V2, V3, V4, V5, V6, V9, V42, V44, V45, V50, V47, V49, 'Idris.Data.List':'un--isNil'(erased, V47)))(V10) end end end end(E4);
							      _ -> erlang:throw("Error: Unreachable branch")
							    end
							  end
							end
...
'case--doUpdates-2698'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--case block in doUpdates-2600'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      [E0 | E1] ->
	  fun (V6, V7) ->
		  case V6 of
...
'case--doUpdates-2572'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'nested--10953-2524--in--un--spanSpace'(V0, V1, V2, V3, V4) ->
    case V4 of
	  ...
	  fun (V5, V6) ->
		  case V5 of
		    ...
		    {'Idris.Idris.IDEMode.TokenLine.Whitespace', E2} -> fun (V7) -> 'Idris.Prelude':'un--mapFst'(erased, erased, erased, fun (V8) -> [V5 | V8] end, 'nested--10953-2524--in--un--spanSpace'(V0, V1, V2, V3, V6)) end(E2);
		    _ -> 'Idris.Prelude':'dn--un--map_Functor__(Pair $a)'(erased, erased, erased, fun (V9) -> [V5 | V9] end, 'nested--10953-2524--in--un--spanSpace'(V0, V1, V2, V3, V6))
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--11703-3209--in--un--indent'(V0, V1, V2, V3, V4, V5, V6) ->
    case V5 of
...
'un--updateCase'(V0, V1, V2, V3, V4, V5, V6) ->
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V37) ->
		    ('case--updateCase-2914'(V5, V4, V3, V2, V1, V0, V37,
					     case V37 of
				...
				fun (V6) ->
					begin
					  ...
					  case V7 of
					    ...
					    {'Idris.Prelude.Right', E4} -> fun (V9) -> {'Idris.Prelude.Right', [{'Idris.Builtin.MkPair', V5, 'Idris.Idris.Syntax':'dn--un--show_Show__PTerm'('nested--10888-2459--in--un--bracket'(V5, V4, V1, V0, V9))}]} end(E4);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end
					end
				end
																...
																{'Idris.Prelude.Right', E18} ->
																    fun (V60) ->
																	    begin
																	      ...
																	      case V60 of
																		{'Idris.Prelude.Just', E19} -> fun (V62) -> begin V63 = {'Idris.Prelude.Just', V62}, ('case--case block in case block in getClause-3359'(V4, V3, V2, V1, V0, V36, V43, V45, V47, V48, V61, V51, V57, V62, V63, 'Idris.Parser.Unlit':'un--isLitLine'(V62)))(V5) end end(E19);
																		{'Idris.Prelude.Nothing'} -> fun () -> {'Idris.Prelude.Right', {'Idris.Prelude.Nothing'}} end();
																		_ -> erlang:throw("Error: Unreachable branch")
																	      end
																	    end
...
'un--fnName'(V0, V1) ->
    case V1 of
      {'Idris.Core.Name.UN', E0} -> fun (V2) -> 'case--fnName-3179'(V2, V0, 'Idris.Parser.Lexer.Common':'un--isIdentNormal'(V2)) end(E0);
...
'un--doUpdates'(V0, V1, V2, V3) ->
    case V3 of
	  ...
	  fun (V5, V6) ->
		  case V5 of
		    {'Idris.Idris.IDEMode.TokenLine.LBrace'} -> fun () -> 'case--doUpdates-2572'(V6, V2, V1, V0, 'nested--10953-2524--in--un--spanSpace'(V6, V2, V1, V0, V6)) end();
		    {'Idris.Idris.IDEMode.TokenLine.Name', E4} -> fun (V7) -> 'case--doUpdates-2698'(V7, V6, V2, V1, V0, 'Idris.Data.List':'un--lookup'(erased, erased, {'Idris.Prelude.dn--un--__mkEq', fun (V8) -> fun (V9) -> 'Idris.Prelude':'dn--un--==_Eq__String'(V8, V9) end end, fun (V10) -> fun (V11) -> 'Idris.Prelude':'dn--un--/=_Eq__String'(V10, V11) end end}, V7, V2)) end(E4);
