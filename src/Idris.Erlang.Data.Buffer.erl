		  ...
		  case case V1 of
			...
			fun (V11, V12, V13) ->
				(((V12(erased))(erased))(case V1 of
							   {'Idris.Prelude.dn--un--__mkHasIO', E5, E6} -> fun (V14, V15) -> (V15(erased))(fun (V16) -> erlang:apply(file, write_file, [unicode:characters_to_binary(V4), V7]) end) end(E5, E6);
							   _ -> erlang:throw("Error: Unreachable branch")
							 end))(fun (V17) ->
...
'case--createBufferFromFile-3255'(V0, V1, V2, V3, V4) ->
    case V4 of
	  ...
	  fun (V5) ->
		  case V5 of
			...
			fun (V6, V7) ->
				case V7 of
				  E27 ->
				      fun (V8) ->
					      case case V1 of
						     {'Idris.Prelude.dn--un--__mkHasIO', E55, E56} -> fun (V9, V10) -> V9 end(E55, E56);
						     _ -> erlang:throw("Error: Unreachable branch")
						   end
						  of
						{'Idris.Prelude.dn--un--__mkMonad', E28, E29, E30} ->
						    fun (V11, V12, V13) ->
							    (((V12(erased))(erased))(case V1 of
										       {'Idris.Prelude.dn--un--__mkHasIO', E31, E32} -> fun (V14, V15) -> (V15(erased))(fun (V16) -> erlang:apply(erlang, byte_size, [V8]) end) end(E31, E32);
										       _ -> erlang:throw("Error: Unreachable branch")
										     end))(fun (V17) ->
												   case case V1 of
													  {'Idris.Prelude.dn--un--__mkHasIO', E53, E54} -> fun (V18, V19) -> V18 end(E53, E54);
													  _ -> erlang:throw("Error: Unreachable branch")
													end
												       of
												     {'Idris.Prelude.dn--un--__mkMonad', E33, E34, E35} ->
													 fun (V20, V21, V22) ->
														 (((V21(erased))(erased))(case V1 of
																	    {'Idris.Prelude.dn--un--__mkHasIO', E36, E37} -> fun (V23, V24) -> (V24(erased))(fun (V25) -> erlang:apply(erlang, make_ref, []) end) end(E36, E37);
																	    _ -> erlang:throw("Error: Unreachable branch")
																	  end))(fun (V26) ->
																			case case V1 of
																			       {'Idris.Prelude.dn--un--__mkHasIO', E51, E52} -> fun (V27, V28) -> V27 end(E51, E52);
																			       _ -> erlang:throw("Error: Unreachable branch")
																			     end
																			    of
																			  {'Idris.Prelude.dn--un--__mkMonad', E38, E39, E40} ->
																			      fun (V29, V30, V31) ->
																				      (((V30(erased))(erased))(case V1 of
																								 {'Idris.Prelude.dn--un--__mkHasIO', E41, E42} -> fun (V32, V33) -> (V33(erased))(fun (V34) -> erlang:apply(erlang, put, [V26, {V8, V17}]) end) end(E41, E42);
																								 _ -> erlang:throw("Error: Unreachable branch")
																							       end))(fun (V35) ->
																									     case case case V1 of
																											 {'Idris.Prelude.dn--un--__mkHasIO', E49, E50} -> fun (V36, V37) -> V36 end(E49, E50);
																											 _ -> erlang:throw("Error: Unreachable branch")
																										       end
																										      of
																										    {'Idris.Prelude.dn--un--__mkMonad', E46, E47, E48} -> fun (V38, V39, V40) -> V38 end(E46, E47, E48);
																										    _ -> erlang:throw("Error: Unreachable branch")
																										  end
																										 of
																									       {'Idris.Prelude.dn--un--__mkApplicative', E43, E44, E45} -> fun (V41, V42, V43) -> (V42(erased))({'Idris.Prelude.Right', V26}) end(E43, E44, E45);
																									       _ -> erlang:throw("Error: Unreachable branch")
																									     end
																								     end)
																			      end(E38, E39, E40);
				  ...
				  _ ->
				      case case case V1 of
						  {'Idris.Prelude.dn--un--__mkHasIO', E25, E26} -> fun (V44, V45) -> V44 end(E25, E26);
						  _ -> erlang:throw("Error: Unreachable branch")
						end
					       of
					     {'Idris.Prelude.dn--un--__mkMonad', E22, E23, E24} -> fun (V46, V47, V48) -> V46 end(E22, E23, E24);
					     _ -> erlang:throw("Error: Unreachable branch")
					   end
					  of
					{'Idris.Prelude.dn--un--__mkApplicative', E19, E20, E21} -> fun (V49, V50, V51) -> (V50(erased))({'Idris.Prelude.Left', {'Idris.Erlang.System.File.FileReadError'}}) end(E19, E20, E21);
					_ -> erlang:throw("Error: Unreachable branch")
				      end
				end
			end(E17, E18);
		    _ ->
			case case case V1 of
				    {'Idris.Prelude.dn--un--__mkHasIO', E15, E16} -> fun (V52, V53) -> V52 end(E15, E16);
				    _ -> erlang:throw("Error: Unreachable branch")
				  end
				 of
			       {'Idris.Prelude.dn--un--__mkMonad', E12, E13, E14} -> fun (V54, V55, V56) -> V54 end(E12, E13, E14);
			       _ -> erlang:throw("Error: Unreachable branch")
			     end
			    of
			  {'Idris.Prelude.dn--un--__mkApplicative', E9, E10, E11} -> fun (V57, V58, V59) -> (V58(erased))({'Idris.Prelude.Left', {'Idris.Erlang.System.File.FileReadError'}}) end(E9, E10, E11);
			  _ -> erlang:throw("Error: Unreachable branch")
			end
		  end
	  end(E8);
      _ ->
	  case case case V1 of
		      {'Idris.Prelude.dn--un--__mkHasIO', E6, E7} -> fun (V60, V61) -> V60 end(E6, E7);
		      _ -> erlang:throw("Error: Unreachable branch")
		    end
		   of
		 {'Idris.Prelude.dn--un--__mkMonad', E3, E4, E5} -> fun (V62, V63, V64) -> V62 end(E3, E4, E5);
		 _ -> erlang:throw("Error: Unreachable branch")
	       end
	      of
	    {'Idris.Prelude.dn--un--__mkApplicative', E0, E1, E2} -> fun (V65, V66, V67) -> (V66(erased))({'Idris.Prelude.Left', {'Idris.Erlang.System.File.FileReadError'}}) end(E0, E1, E2);
	    _ -> erlang:throw("Error: Unreachable branch")
	  end
    end.

'case--getString-3115'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      E0 ->
	  fun (V7) ->
		  case case case V1 of
			 ...
			 _ -> erlang:throw("Error: Unreachable branch")
		      ...
		      of
		    {'Idris.Prelude.dn--un--__mkApplicative', E1, E2, E3} -> fun (V13, V14, V15) -> (V14(erased))(V7) end(E1, E2, E3);
		    _ -> erlang:throw("Error: Unreachable branch")
		  end
	  end(E0);
      _ -> erlang:throw("Error: Unreachable branch")
...
'nested--3556-3145--in--un--unpackTo'(V0, V1, V2, V3, V4) ->
    case V4 of
      0 ->
	  case case case V1 of
	  ...
	  case case V1 of
		 ...
		 _ -> erlang:throw("Error: Unreachable branch")
	      ...
	      of
	    {'Idris.Prelude.dn--un--__mkMonad', E0, E1, E2} -> fun (V15, V16, V17) -> (((V16(erased))(erased))('un--getByte'(erased, V1, V2, 'Idris.Prelude':'dn--un---_Neg__Int'(V4, 1))))(fun (V18) -> 'nested--3556-3145--in--un--unpackTo'(erased, V1, V2, [V18 | V3], 'Idris.Prelude':'dn--un---_Neg__Int'(V4, 1)) end) end(E0, E1, E2);
	    _ -> erlang:throw("Error: Unreachable branch")
	  end
    end.
																			   ...
																			   {'Idris.Prelude.dn--un--__mkMonad', E10, E11, E12} ->
																			       fun (V24, V25, V26) ->
																				       (((V25(erased))(erased))(case V1 of
																								  {'Idris.Prelude.dn--un--__mkHasIO', E13, E14} -> fun (V27, V28) -> (V28(erased))(fun (V29) -> erlang:apply(file, write_file, [unicode:characters_to_binary(V2), V20]) end) end(E13, E14);
																								  _ -> erlang:throw("Error: Unreachable branch")
																								end))(fun (V30) ->
																									      case case case V1 of
...
'un--stringByteLength'(V0) -> 'Idris.PrimIO':'un--unsafePerformIO'(erased, fun (V1) -> begin V2 = erlang:apply(erlang, iolist_to_binary, [V0]), erlang:apply(erlang, byte_size, [V2]) end end).
	...
	of
	  ...
	  fun (V7, V8, V9) ->
		  (((V8(erased))(erased))(case V1 of
					    {'Idris.Prelude.dn--un--__mkHasIO', E3, E4} -> fun (V10, V11) -> (V11(erased))(fun (V12) -> erlang:apply(erlang, iolist_to_binary, [V4]) end) end(E3, E4);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end))(fun (V13) ->
							case case V1 of
							       {'Idris.Prelude.dn--un--__mkHasIO', E25, E26} -> fun (V14, V15) -> V14 end(E25, E26);
							       _ -> erlang:throw("Error: Unreachable branch")
							     end
							    of
							  {'Idris.Prelude.dn--un--__mkMonad', E5, E6, E7} ->
							      fun (V16, V17, V18) ->
								      (((V17(erased))(erased))(case V1 of
												 {'Idris.Prelude.dn--un--__mkHasIO', E8, E9} -> fun (V19, V20) -> (V20(erased))(fun (V21) -> erlang:apply(erlang, get, [V2]) end) end(E8, E9);
												 _ -> erlang:throw("Error: Unreachable branch")
											       end))(fun (V22) ->
													     case case V1 of
														    {'Idris.Prelude.dn--un--__mkHasIO', E23, E24} -> fun (V23, V24) -> V23 end(E23, E24);
														    _ -> erlang:throw("Error: Unreachable branch")
														  end
														 of
													       {'Idris.Prelude.dn--un--__mkMonad', E10, E11, E12} ->
														   fun (V25, V26, V27) ->
															   (((V26(erased))(erased))(case V1 of
																		      {'Idris.Prelude.dn--un--__mkHasIO', E13, E14} ->
																			  fun (V28, V29) ->
																				  (V29(erased))(fun (V30) ->
																		      ...
																		      _ -> erlang:throw("Error: Unreachable branch")
																				  ...
																				  case case case V1 of
																					      {'Idris.Prelude.dn--un--__mkHasIO', E21, E22} -> fun (V32, V33) -> V32 end(E21, E22);
																					      _ -> erlang:throw("Error: Unreachable branch")
																					    end
																					   of
																					 {'Idris.Prelude.dn--un--__mkMonad', E18, E19, E20} -> fun (V34, V35, V36) -> V34 end(E18, E19, E20);
																					 _ -> erlang:throw("Error: Unreachable branch")
																				       end
																				      of
																				    {'Idris.Prelude.dn--un--__mkApplicative', E15, E16, E17} -> fun (V37, V38, V39) -> (V38(erased))({'Idris.Builtin.MkUnit'}) end(E15, E16, E17);
																				    _ -> erlang:throw("Error: Unreachable branch")
																				  end
																			  end)
														   end(E10, E11, E12);
	  ...
	  fun (V7, V8, V9) ->
		  (((V8(erased))(erased))(case V1 of
					    ...
					    _ -> erlang:throw("Error: Unreachable branch")
							...
							'case--getString-3115'(erased, V1, V4, V3, V2, V13,
									       fun ({Bin, BufSize}, Loc, Len) when Loc + Len =< erlang:byte_size(Bin) -> <<_:Loc/binary, Value:Len/binary, _/binary>> = Bin, Value;
										   ({Bin, BufSize}, Loc, Len) -> binary:copy(<<0>>, Len)
									       end(V13, V3, V4))
						end)
...
'un--createBufferFromFile'(V0, V1, V2) ->
	...
	of
	  ...
	  fun (V5, V6, V7) ->
		  (((V6(erased))(erased))(case V1 of
					    {'Idris.Prelude.dn--un--__mkHasIO', E3, E4} -> fun (V8, V9) -> (V9(erased))(fun (V10) -> erlang:apply(file, read_file, [unicode:characters_to_binary(V2)]) end) end(E3, E4);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end))(fun (V11) -> 'case--createBufferFromFile-3255'(erased, V1, V2, V11, 'Idris.Erlang.Data.Decode':'un--erlDecode'(erased, erased, {'Idris.Erlang.Data.ETErlTerm'}, fun (V12) -> 'Idris.Erlang.Data.Decode':'un--tuple2'(erased, erased, fun (V13) -> 'Idris.Erlang.Data.Decode':'un--exact'(erased, {'Idris.Erlang.Data.ETErlAtom'}, ok, V13) end, fun (V14) -> 'Idris.Erlang.Data.Decode':'un--binary'(V14) end, V12) end, V11)) end)
	  end(E0, E1, E2);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
...
'un--bufferData'(V0, V1, V2) ->
	...
	of
      {'Idris.Prelude.dn--un--__mkMonad', E0, E1, E2} -> fun (V5, V6, V7) -> (((V6(erased))(erased))('un--rawSize'(erased, V1, V2)))(fun (V8) -> 'nested--3556-3145--in--un--unpackTo'(erased, V1, V2, [], V8) end) end(E0, E1, E2);
      _ -> erlang:throw("Error: Unreachable branch")
    end.