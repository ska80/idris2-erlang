...
-export(['case--perror-3777'/8, 'case--perror-3473'/5, 'case--perror-3307'/8, 'case--perror-3144'/8, 'case--perror-3028'/8, 'case--ploc-2637'/10, 'case--ploc,addLineNumbers-2566'/7, 'nested--10834-3644--in--un--tshow'/10, 'nested--10834-3109--in--un--showRig'/8, 'nested--10834-3110--in--un--showRel'/8, 'nested--10834-2762--in--un--showPVar'/9, 'nested--10834-4290--in--un--showMod'/5, 'nested--10834-3845--in--un--showHoles'/5, 'nested--10640-2529--in--un--repeatChar'/6, 'nested--10834-3393--in--un--pAlterror'/5, 'nested--10640-2528--in--un--extractRange'/8, 'nested--10834-3712--in--un--dropEnv'/10, 'nested--10834-3394--in--un--allUndefined'/5, 'nested--10640-2530--in--un--addLineNumbers'/6, 'un--pwarning'/4, 'un--pshowNoNorm'/6, 'un--pshow'/6, 'un--ploc'/2, 'un--perror'/4, 'un--displayWarning'/5, 'un--display'/5]).

'case--perror-3777'(V0, V1, V2, V3, V4, V5, V6, V7) ->
    case V7 of
...
'case--perror-3473'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Prelude.Just', E2} -> fun (V5) -> 'un--perror'(V3, V2, V1, V5) end(E2);
      _ ->
	  fun (V6) ->
		  begin
		    V8 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V7) -> 'nested--10834-3393--in--un--pAlterror'(V0, V1, V2, V3, V7) end, V0))(V6),
		    case V8 of
	  ...
	  fun (V12) ->
		  begin
		    ...
		    case V13 of
		      ...
		      {'Idris.Prelude.Right', E3} -> fun (V15) -> {'Idris.Prelude.Right', 'Idris.Prelude.Strings':'un--++'(<<"Trying to use "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--10834-3109--in--un--showRig'(V0, V1, V2, V3, V4, V5, V6, V1), 'Idris.Prelude.Strings':'un--++'(<<" name "/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Idris.Resugar':'un--sugarName'(V2), 'Idris.Prelude.Strings':'un--++'(<<" in "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--10834-3110--in--un--showRel'(V0, V1, V2, V3, V4, V5, V6, V0), 'Idris.Prelude.Strings':'un--++'(<<" context at:\n"/utf8>>, V15)))))))} end(E3);
		      _ -> erlang:throw("Error: Unreachable branch")
		    end
		  end
	  end;
...
'case--perror-3028'(V0, V1, V2, V3, V4, V5, V6, V7) ->
    case V0 of
      [E0 | E1] ->
	  fun (V8, V9) ->
		  case V9 of
...
'case--ploc-2637'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      0 -> fun (V10) -> {'Idris.Prelude.Right', 'Idris.Prelude.Strings':'un--++'('Idris.Prelude':'dn--un--show_Show__Nat'('Idris.Prelude':'dn--un--+_Num__Nat'(V4, 1 + 0)), 'Idris.Prelude.Strings':'un--++'(<<"\t"/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Data.Maybe':'un--fromMaybe'(erased, fun () -> <<""/utf8>> end, 'Idris.Data.List.Extra':'un--elemAt'(erased, V8, V4)), 'Idris.Prelude.Strings':'un--++'(<<"\n\t"/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--10640-2529--in--un--repeatChar'(V0, V1, V2, V3, V5, $\s), 'Idris.Prelude.Strings':'un--++'('nested--10640-2529--in--un--repeatChar'(V0, V1, V2, V3, 'Idris.Prelude':'un--minus'(V7, V5), $^), <<"\n"/utf8>>))))))} end;
      1 -> fun (V11) -> {'Idris.Prelude.Right', 'nested--10640-2530--in--un--addLineNumbers'(V0, V1, V2, V3, V4, 'nested--10640-2528--in--un--extractRange'(V0, V1, V2, V3, erased, V4, V6, V8))} end;
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--ploc,addLineNumbers-2566'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'nested--10834-3644--in--un--tshow'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
...
'nested--10640-2529--in--un--repeatChar'(V0, V1, V2, V3, V4, V5) -> 'Idris.Prelude':'un--pack'('Idris.Prelude':'un--take'(erased, V4, 'Idris.Data.Stream':'un--repeat'(erased, V5))).

'nested--10834-3393--in--un--pAlterror'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V5, V6) ->
		  case V5 of
...
'nested--10640-2528--in--un--extractRange'(V0, V1, V2, V3, V4, V5, V6, V7) -> 'Idris.Data.List':'un--take'(erased, 'Idris.Prelude':'dn--un--+_Num__Nat'('Idris.Prelude':'un--minus'(V6, V5), 1 + 0), 'Idris.Data.List':'un--drop'(erased, V5, V7)).

'nested--10834-3712--in--un--dropEnv'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      {'Idris.Core.TT.Bind', E0, E1, E2, E3} ->
	  fun (V10, V11, V12, V13) ->
		  case V12 of
		    {'Idris.Core.TT.Pi', E4, E5, E6} -> fun (V14, V15, V16) -> 'nested--10834-3712--in--un--dropEnv'(V0, V1, V2, V3, V4, V5, V6, [V11 | V7], {'Idris.Core.Env.::', V12, V8}, V13) end(E4, E5, E6);
		    {'Idris.Core.TT.Let', E7, E8, E9} -> fun (V17, V18, V19) -> 'nested--10834-3712--in--un--dropEnv'(V0, V1, V2, V3, V4, V5, V6, [V11 | V7], {'Idris.Core.Env.::', V12, V8}, V13) end(E7, E8, E9);
...
'nested--10834-3394--in--un--allUndefined'(V0, V1, V2, V3, V4) ->
    case V4 of
      [] -> {'Idris.Prelude.Nothing'};
      [E0 | E1] ->
	  fun (V5, V6) ->
				...
				case V8 of
				  {'Idris.Core.Core.UndefinedName', E4, E5} ->
				      fun (V9, V10) ->
						...
						_ -> 'nested--10834-3394--in--un--allUndefined'(V0, V1, V2, V3, V6)
					      end
				      end(E4, E5);
...
'nested--10640-2530--in--un--addLineNumbers'(V0, V1, V2, V3, V4, V5) ->
			  ...
			  fun (V10) ->
				  begin
				    ...
				    case V15 of
				      ...
				      {'Idris.Prelude.Right', E6} -> fun (V17) -> ('case--ploc-2637'(V3, V5, V4, V0, V6, V7, V8, V9, V17, 'Idris.Prelude':'dn--un--==_Eq__Nat'(V6, V8)))(V10) end(E6);
				      _ -> erlang:throw("Error: Unreachable branch")
				    end
				  end
			  end
...
'un--perror'(V0, V1, V2, V3) ->
    case V3 of
				  ...
				  fun (V43) ->
					  begin
					    ...
					    case V44 of
					      ...
					      {'Idris.Prelude.Right', E31} -> fun (V46) -> {'Idris.Prelude.Right', 'Idris.Prelude.Strings':'un--++'(<<"Pattern variable "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--10834-2762--in--un--showPVar'(V35, V39, V38, V37, V36, V2, V1, V0, V38), 'Idris.Prelude.Strings':'un--++'(<<" unifies with:\n\t"/utf8>>, 'Idris.Prelude.Strings':'un--++'(V43, 'Idris.Prelude.Strings':'un--++'(<<"\nat:\n"/utf8>>, V46)))))} end(E31);
					      _ -> erlang:throw("Error: Unreachable branch")
					    end
					  end
				  end(E29);
      ...
      {'Idris.Core.Core.AllFailed', E181} -> fun (V277) -> 'case--perror-3473'(V277, V2, V1, V0, 'nested--10834-3394--in--un--allUndefined'(V277, V2, V1, V0, V277)) end(E181);
	  ...
	  fun (V363, V364, V365, V366) ->
		  fun (V367) ->
			  begin
			    V369 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V368) -> 'nested--10834-3644--in--un--tshow'(V363, V366, V365, V364, V2, V1, V0, V363, V365, V368) end, V366))(V367),
			    case V369 of
      ...
      {'Idris.Core.Core.CantSolveGoal', E248, E249, E250, E251} -> fun (V387, V388, V389, V390) -> 'case--perror-3777'(V387, V390, V389, V388, V2, V1, V0, 'nested--10834-3712--in--un--dropEnv'(V387, V390, V389, V388, V2, V1, V0, V387, V389, V390)) end(E248, E249, E250, E251);
      ...
      {'Idris.Core.Core.CyclicImports', E407} -> fun (V622) -> fun (V623) -> {'Idris.Prelude.Right', 'Idris.Prelude.Strings':'un--++'(<<"Module imports form a cycle: "/utf8>>, 'Idris.Core.Name':'un--showSep'(<<" -> "/utf8>>, 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V624) -> 'nested--10834-4290--in--un--showMod'(V622, V2, V1, V0, V624) end, V622)))} end end(E407);
