...
-export(['case--yaffleMain-1274'/11, 'dn--un--resolved_HasNames__(|Unit,MkUnit|)'/3, 'dn--un--full_HasNames__(|Unit,MkUnit|)'/3, 'dn--un--__Impl_HasNames_(|Unit,MkUnit|)'/0, 'un--yaffleMain'/3, 'un--usage'/0, 'un--processArgs'/1]).

'case--yaffleMain-1274'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
													...
													{'Idris.Prelude.Right', E13} ->
													    fun (V23) ->
															...
															{'Idris.Prelude.Right', E15} ->
															    fun (V26) ->
																    begin
																      V27 = ('case--yaffleMain-1274'(V1, V0, V5, V8, V11, V14, V17, V20, V23, V26, 'Idris.Utils.Path':'un--extension'(V0)))(V2),
																      case V27 of
