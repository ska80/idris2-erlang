...
-export(['case--case block in readMetadata-4078'/5, 'case--readMetadata-4055'/2, 'case--readFromTTM-4001'/3, 'case--writeToTTM-3940'/9, 'case--normaliseTypes-3489'/5, 'case--findEntryWith-3276'/6, 'case--withCurrentLHS-3229'/6, 'case--clearHoleLHS-3190'/2, 'case--setHoleLHS-3160'/3, 'case--addTyDecl-3096'/9, 'case--addNameType-3019'/9, 'case--addLHS-2927'/9, 'nested--8602-2856--in--un--toPat'/9, 'nested--9202-3413--in--un--nfType'/4, 'nested--9378-3589--in--un--fullTy'/7, 'nested--9378-3588--in--un--fullLHS'/7, 'nested--9378-3590--in--un--fullHLHS'/7, 'dn--un--toBuf_TTC__TTMFile'/3, 'dn--un--toBuf_TTC__Metadata'/3, 'dn--un--show_Show__Metadata'/1, 'dn--un--full_HasNames__Metadata'/2, 'dn--un--fromBuf_TTC__TTMFile'/2, 'dn--un--fromBuf_TTC__Metadata'/2, 'dn--un--__Impl_TTC_TTMFile'/0, 'un--writeToTTM'/4, 'un--withCurrentLHS'/4, 'un--substEnv'/4, 'un--setHoleLHS'/3, 'un--readMetadata'/2, 'un--readFromTTM'/3, 'un--normaliseTypes'/3, 'un--initMetadata'/0, 'un--findTypeAt'/3, 'un--findTyDeclAt'/3, 'un--findLHSAt'/3, 'un--findHoleLHS'/3, 'un--findEntryWith'/3, 'un--dumpTTM'/2, 'un--clearHoleLHS'/2, 'un--addTyDecl'/8, 'un--addNameType'/8, 'un--addLHS'/8]).

'case--case block in readMetadata-4078'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Core.Metadata.MkTTMFile', E0, E1} -> fun (V5, V6) -> fun (V7) -> {'Idris.Prelude.Right', V6} end end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--readMetadata-4055'(V0, V1) ->
    case V1 of
...
'case--readFromTTM-4001'(V0, V1, V2) ->
    case V2 of
      {'Idris.Prelude.Right', E0} ->
	  fun (V3) ->
		  fun (V4) ->
...
'case--writeToTTM-3940'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
...
'case--normaliseTypes-3489'(V0, V1, V2, V3, V4) ->
    case V2 of
...
'case--findEntryWith-3276'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--withCurrentLHS-3229'(V0, V1, V2, V3, V4, V5) ->
    case V3 of
...
'case--addTyDecl-3096'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V7 of
...
'case--addNameType-3019'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V7 of
...
'case--addLHS-2927'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V7 of
...
'nested--8602-2856--in--un--toPat'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
      {'Idris.Core.Env.::', E0, E1} ->
	  fun (V9, V10) ->
		  case V9 of
		    {'Idris.Core.TT.Lam', E2, E3, E4} -> fun (V11, V12, V13) -> {'Idris.Core.Env.::', {'Idris.Core.TT.PVar', V11, V12, V13}, 'nested--8602-2856--in--un--toPat'(V0, V1, V2, V3, V4, V5, V6, erased, V10)} end(E2, E3, E4);
		    _ -> {'Idris.Core.Env.::', V9, 'nested--8602-2856--in--un--toPat'(V0, V1, V2, V3, V4, V5, V6, erased, V10)}
		  end
	  end(E0, E1);
...
'nested--9202-3413--in--un--nfType'(V0, V1, V2, V3) ->
    case V3 of
...
'nested--9378-3589--in--un--fullTy'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V7, V8) ->
		  case V8 of
...
'nested--9378-3588--in--un--fullLHS'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V7, V8) ->
		  case V8 of
...
'nested--9378-3590--in--un--fullHLHS'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V7, V8) ->
		  fun (V9) ->
...
'dn--un--full_HasNames__Metadata'(V0, V1) ->
    case V1 of
	  ...
	  fun (V2, V3, V4, V5, V6) ->
		  fun (V7) ->
			  begin
			    V9 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V8) -> 'nested--9378-3588--in--un--fullLHS'(V6, V5, V4, V3, V2, V0, V8) end, V2))(V7),
			    case V9 of
			      {'Idris.Prelude.Left', E5} -> fun (V10) -> {'Idris.Prelude.Left', V10} end(E5);
			      {'Idris.Prelude.Right', E6} ->
				  fun (V11) ->
					  begin
					    V13 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V12) -> 'nested--9378-3589--in--un--fullTy'(V6, V5, V4, V3, V2, V0, V12) end, V3))(V7),
					    case V13 of
					      {'Idris.Prelude.Left', E7} -> fun (V14) -> {'Idris.Prelude.Left', V14} end(E7);
					      {'Idris.Prelude.Right', E8} ->
						  fun (V15) ->
							  begin
							    V17 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V16) -> 'nested--9378-3589--in--un--fullTy'(V6, V5, V4, V3, V2, V0, V16) end, V4))(V7),
							    case V17 of
							      {'Idris.Prelude.Left', E9} -> fun (V18) -> {'Idris.Prelude.Left', V18} end(E9);
							      {'Idris.Prelude.Right', E10} ->
								  fun (V19) ->
									  begin
									    V21 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V20) -> 'nested--9378-3590--in--un--fullHLHS'(V6, V5, V4, V3, V2, V0, V20) end, V6))(V7),
									    case V21 of
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V33) ->
			...
			{'Idris.Prelude.Right', E3} ->
			    fun (V64) ->
				    begin
				      V71 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V65) -> 'nested--9202-3413--in--un--nfType'(V1, V0, V64, V65) end,
									      case V33 of
...
'un--findEntryWith'(V0, V1, V2) ->
    case V2 of
	  ...
	  fun (V3, V4) ->
		  case V3 of
		    {'Idris.Builtin.MkPair', E2, E3} -> fun (V5, V6) -> 'case--findEntryWith-3276'(erased, V5, V6, V4, V1, (V1(V5))(V6)) end(E2, E3);
		    _ -> erlang:throw("Error: Unreachable branch")
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
...
'un--addLHS'(V0, V1, V2, V3, V4, V5, V6, V7) ->
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V38) ->
		    begin
		      V43 = 'Idris.Core.Context':'un--toFullNames'(erased, V1, {'Idris.Core.Context.dn--un--__mkHasNames', fun (V39) -> fun (V40) -> 'Idris.Core.Context':'dn--un--full_HasNames__(Term $vars)'(erased, V39, V40) end end, fun (V41) -> fun (V42) -> 'Idris.Core.Context':'dn--un--resolved_HasNames__(Term $vars)'(erased, V41, V42) end end}, 'Idris.Core.Env':'un--bindEnv'(V0, V3, 'nested--8602-2856--in--un--toPat'(V0, V6, V5, V4, V3, V2, V1, erased, V5), V6), V7),
		      case V43 of
