	  ...
	  fun (V19) ->
		  begin
		    ...
		    case V48 of
			  ...
			  fun (V50) ->
				  begin
				    V52 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V51) -> 'nested--10243-1682--in--un--showFld'(V0, V1, V2, V51) end, V0))(V19),
				    case V52 of
...
'nested--10243-1682--in--un--showFld'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V4, V5) ->
		  fun (V6) ->
...
'nested--9565-1083--in--un--notWorld'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
      {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> 1 end();
      _ -> 0
    end.

'nested--9565-1079--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      [] -> [];
      [E0 | E1] ->
	  fun (V10, V11) ->
		  case V10 of
		    {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> [{'Idris.Prelude.Nothing'} | 'nested--9565-1079--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V11)] end();
		    _ -> [{'Idris.Prelude.Just', 'Idris.Prelude.Strings':'un--++'(<<"cb"/utf8>>, 'Idris.Prelude':'dn--un--show_Show__Int'(V8))} | 'nested--9565-1079--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, (V8 + 1) rem 9223372036854775808, V11)]
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--9565-1082--in--un--mkFun'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) -> begin V11 = 'nested--9565-1079--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, 0, V8), 'Idris.Prelude.Strings':'un--++'(<<"(lambda ("/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Core.Name':'un--showSep'(<<" "/utf8>>, 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V12) -> V12 end, V11)), 'Idris.Prelude.Strings':'un--++'(<<") "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--9565-1080--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V10, V11), <<")"/utf8>>)))) end.

'nested--8823-311--in--un--isLib'(V0, V1, V2) -> 'case--findLibs,isLib-315'(V0, V1, V2, 'Idris.Data.Strings':'un--isPrefixOf'(<<"lib"/utf8>>, V2)).

'nested--8867-354--in--un--escape'(V0, V1, V2) ->
    case V1 of
      $" -> [$\\, $" | V2];
      $\\ -> [$\\, $\\ | V2];
      _ -> [V1 | V2]
...
'nested--9565-1084--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      {'Idris.Core.CompileExpr.CFFun', E4, E5} -> fun (V11, V12) -> 'nested--9565-1084--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, [V11 | V9], V12) end(E4, E5);
      _ ->
	  begin
	    V13 = 'Idris.Data.List':'un--reverse'(erased, V9),
	    fun (V14) ->
		    begin
		      V17 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V15) -> 'un--cftySpec'(V4, V15) end, 'Idris.Data.List':'un--filter'(erased, fun (V16) -> 'nested--9565-1083--in--un--notWorld'(V0, V1, V2, V3, V4, V5, V6, V7, V16) end, V13)))(V14),
		      case V17 of
			...
			{'Idris.Prelude.Right', E1} ->
			    fun (V19) ->
					...
					{'Idris.Prelude.Right', E3} -> fun (V22) -> {'Idris.Prelude.Right', 'Idris.Prelude.Strings':'un--++'(<<"(let ([c-code (foreign-callable #f "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--9565-1082--in--un--mkFun'(V0, V1, V2, V3, V4, V5, V6, V7, V13, V10, V8), 'Idris.Prelude.Strings':'un--++'(<<" ("/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Core.Name':'un--showSep'(<<" "/utf8>>, V19), 'Idris.Prelude.Strings':'un--++'(<<") "/utf8>>, 'Idris.Prelude.Strings':'un--++'(V22, 'Idris.Prelude.Strings':'un--++'(<<")])"/utf8>>, <<" (lock-object c-code) (foreign-callable-entry-point c-code))"/utf8>>)))))))} end(E3);
					_ -> erlang:throw("Error: Unreachable branch")
				      end
				    end
			    end(E1);
...
'nested--9565-1085--in--un--buildArg'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V9, V10) ->
		  case V10 of
		    {'Idris.Core.CompileExpr.CFFun', E2, E3} -> fun (V11, V12) -> 'nested--9565-1084--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, 'Idris.Compiler.Scheme.Common':'un--schName'(V9), [V11], V12) end(E2, E3);
...
'nested--9565-1080--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      [] -> V8;
      [E0 | E1] ->
	  fun (V10, V11) ->
		  case V10 of
		    {'Idris.Prelude.Nothing'} -> fun () -> 'nested--9565-1080--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, 'Idris.Prelude.Strings':'un--++'(<<"("/utf8>>, 'Idris.Prelude.Strings':'un--++'(V8, <<" #f)"/utf8>>)), V11) end();
		    {'Idris.Prelude.Just', E2} -> fun (V12) -> 'nested--9565-1080--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, 'Idris.Prelude.Strings':'un--++'(<<"("/utf8>>, 'Idris.Prelude.Strings':'un--++'(V8, 'Idris.Prelude.Strings':'un--++'(<<" "/utf8>>, 'Idris.Prelude.Strings':'un--++'(V12, <<")"/utf8>>)))), V11) end(E2);
		    _ -> erlang:throw("Error: Unreachable branch")
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
...
'un--escapeString'(V0) -> 'Idris.Prelude':'un--pack'('Idris.Prelude':'dn--un--foldr_Foldable__List'(erased, erased, fun (V1) -> fun (V2) -> 'nested--8867-354--in--un--escape'(V0, V1, V2) end end, [], 'Idris.Prelude':'un--unpack'(V0))).
									...
									fun (V53) ->
										begin
										  ...
										  case V54 of
											...
											fun (V56) ->
												begin
												  V58 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V57) -> 'nested--9565-1085--in--un--buildArg'(V7, V6, V5, V4, V3, V2, V1, V0, V57) end, V6))(V11),
												  case V58 of
							  ...
							  fun (V107) ->
								  begin
								    ...
								    case V108 of
									  ...
									  fun (V110) ->
										  begin
										    V112 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V111) -> 'nested--9565-1085--in--un--buildArg'(V7, V6, V5, V4, V3, V2, V1, V0, V111) end, V6))(V65),
										    case V112 of
