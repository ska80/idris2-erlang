...
-export(['case--case block in fileInfo-2028'/10, 'case--fileInfo-1971'/8, 'case--case block in writeFile-1735'/7, 'case--writeFile-1707'/5, 'case--case block in readFile-1588'/6, 'case--readFile-1564'/4, 'case--case block in readFile,read-1504'/7, 'case--readFile,read-1455'/6, 'case--fGetChar-1077'/5, 'case--fGetLine-967'/5, 'case--openFile-810'/6, 'case--fileModes-704'/1, 'case--error-666'/1, 'nested--3436-1229--in--un--scanBack'/3, 'nested--3647-1440--in--un--read'/5, 'nested--4561-2319--in--un--getMs'/2, 'nested--4561-2318--in--un--getM'/2, 'dn--un--show_Show__FileError'/1, 'dn--un--showPrec_Show__FileError'/2, 'dn--un--__Impl_Show_FileError'/0, 'un--writeFile'/4, 'un--unknownError'/0, 'un--stdout'/0, 'un--stdin'/0, 'un--stderr'/0, 'un--removeFile'/3, 'un--reason'/1, 'un--readFile'/3, 'un--openFile'/4, 'un--mkMode'/1, 'un--fileStatusTime'/3, 'un--fileSize'/3, 'un--fileModifiedTime'/3, 'un--fileModes'/1, 'un--fileInfo'/6, 'un--fileAccessTime'/3, 'un--fflush'/3, 'un--fPutStrLn'/4, 'un--fPutStr'/4, 'un--fGetLine'/3, 'un--fGetChar'/3, 'un--fEOF'/3, 'un--error'/1, 'un--closeFile'/3, 'un--chmodRaw'/4, 'un--chmod'/4]).

'case--case block in fileInfo-2028'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
...
'case--fileInfo-1971'(V0, V1, V2, V3, V4, V5, V6, V7) ->
    case V7 of
      {'Idris.Prelude.Right', E0} ->
	  fun (V8) ->
		  case V8 of
...
'case--case block in writeFile-1735'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      {'Idris.Prelude.Right', E0} ->
	  fun (V7) ->
		  case V7 of
...
'case--writeFile-1707'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Prelude.Right', E0} ->
	  fun (V5) ->
		  case case V1 of
...
'case--case block in readFile-1588'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      {'Idris.Prelude.Right', E0} ->
	  fun (V6) ->
		  case case V1 of
...
'case--readFile-1564'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Prelude.Right', E0} ->
	  fun (V4) ->
		  case case V1 of
		    ...
		    {'Idris.Prelude.dn--un--__mkMonad', E1, E2, E3} ->
			fun (V7, V8, V9) ->
				(((V8(erased))(erased))('nested--3647-1440--in--un--read'(erased, V1, V2, [], V4)))(fun (V10) ->
															    case V10 of
															      {'Idris.Prelude.Right', E4} ->
																  fun (V11) ->
																	  case case V1 of
...
'case--case block in readFile,read-1504'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      {'Idris.Prelude.Right', E0} -> fun (V7) -> 'nested--3647-1440--in--un--read'(erased, V1, V2, [V7 | V4], V3) end(E0);
...
'case--readFile,read-1455'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      0 ->
	  case case case V1 of
	  ...
	  case case V1 of
		...
		fun (V16, V17, V18) ->
			(((V17(erased))(erased))('un--fGetLine'(erased, V1, V3)))(fun (V19) ->
											  case V19 of
											    {'Idris.Prelude.Right', E11} -> fun (V20) -> 'nested--3647-1440--in--un--read'(erased, V1, V2, [V20 | V4], V3) end(E11);
...
'case--fGetChar-1077'(V0, V1, V2, V3, V4) ->
    case V4 of
      {E0, E1} ->
	  fun (V5, V6) ->
		  case V6 of
		    E2 -> fun (V7) -> 'Idris.Prelude':'un--maybe'(erased, erased, fun () -> {'Idris.Prelude.Left', {'Idris.Erlang.System.File.FileReadError'}} end, fun () -> fun (V8) -> {'Idris.Prelude.Right', 'Idris.Builtin':'un--fst'(erased, erased, V8)} end end, 'Idris.Prelude':'un--strUncons'(V7)) end(E2);
		    _ -> erlang:throw("Error: Unreachable branch")
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
...
'case--fGetLine-967'(V0, V1, V2, V3, V4) ->
    case V4 of
      {E0, E1} -> fun (V5, V6) -> {'Idris.Prelude.Right', 'Idris.Erlang.Data.Conversion':'un--erlUnsafeCast'(erased, {'Idris.Erlang.Data.ETErlTerm'}, erased, {'Idris.Erlang.Data.ETString'}, V6)} end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--openFile-810'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'nested--3436-1229--in--un--scanBack'(V0, V1, V2) ->
    case case V1 of
...
'nested--3647-1440--in--un--read'(V0, V1, V2, V3, V4) ->
    case case V1 of
											 ...
											 of
											   ...
											   fun (V21, V22, V23) ->
												   (((V22(erased))(erased))('un--fGetLine'(erased, V1, V4)))(fun (V24) ->
																				     case V24 of
																				       {'Idris.Prelude.Right', E14} -> fun (V25) -> 'nested--3647-1440--in--un--read'(erased, V1, V2, [V25 | V3], V4) end(E14);
																				       {'Idris.Prelude.Left', E15} ->
																					   fun (V26) ->
																						   case case case V1 of
...
'un--removeFile'(V0, V1, V2) ->
	...
	of
	  ...
	  fun (V5, V6, V7) ->
		  (((V6(erased))(erased))(case V1 of
					    {'Idris.Prelude.dn--un--__mkHasIO', E3, E4} -> fun (V8, V9) -> (V9(erased))(fun (V10) -> erlang:apply(file, delete, [unicode:characters_to_binary(V2)]) end) end(E3, E4);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end))(fun (V11) ->
							case case case V1 of
								    {'Idris.Prelude.dn--un--__mkHasIO', E11, E12} -> fun (V12, V13) -> V12 end(E11, E12);
															...
															{'Idris.Prelude.Right', E3} ->
															    fun (V9) ->
																	...
																	of
																      {'Idris.Prelude.dn--un--__mkMonad', E4, E5, E6} ->
																	  fun (V12, V13, V14) ->
																		  (((V13(erased))(erased))('nested--3647-1440--in--un--read'(erased, V1, V2, [], V9)))(fun (V15) ->
																													       case V15 of
																														 {'Idris.Prelude.Right', E7} ->
																														     fun (V16) ->
																															     case case V1 of
	...
	of
	  ...
	  fun (V6, V7, V8) ->
		  (((V7(erased))(erased))(case V1 of
					    {'Idris.Prelude.dn--un--__mkHasIO', E3, E4} -> fun (V9, V10) -> (V10(erased))(fun (V11) -> erlang:apply(file, open, [unicode:characters_to_binary(V2), 'un--fileModes'(V3)]) end) end(E3, E4);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end))(fun (V12) ->
							case case case V1 of
...
'un--mkMode'(V0) ->
    (('nested--4561-2319--in--un--getMs'(V0,
					 case V0 of
																	  ...
																	  'Idris.Erlang.Data.Decode':'dn--un--<|>_Alternative__ErlDecoder'(erased,
																									   fun (V21) ->
																										   'Idris.Erlang.Data.Decode':'dn--un--map_Functor__ErlDecoder'(erased, erased,
																																		fun (V22) ->
																																			case V22 of
																																			  {E8, E9} -> fun (V23, V24) -> {'Idris.Prelude.Right', 'Idris.Erlang.Data.Conversion':'un--erlUnsafeCast'(erased, {'Idris.Erlang.Data.ETErlTerm'}, erased, {'Idris.Erlang.Data.ETString'}, V24)} end(E8, E9);
																																			  _ -> erlang:throw("Error: Unreachable branch")
																																			end
																																		end,
																																		fun (V25) -> 'Idris.Erlang.Data.Decode':'un--tuple2'(erased, erased, fun (V26) -> 'Idris.Erlang.Data.Decode':'un--exact'(erased, {'Idris.Erlang.Data.ETErlAtom'}, ok, V26) end, fun (V27) -> 'Idris.Erlang.Data.Decode':'un--any'(V27) end, V25) end, V21)
																									   end,
																	  ...
																	  'Idris.Erlang.Data.Decode':'dn--un--<|>_Alternative__ErlDecoder'(erased,
																									   fun (V21) ->
																										   'Idris.Erlang.Data.Decode':'dn--un--map_Functor__ErlDecoder'(erased, erased,
																																		fun (V22) ->
																																			case V22 of
																																			  {E8, E9} ->
																																			      fun (V23, V24) ->
																																				      case V24 of
																																					E10 -> fun (V25) -> 'Idris.Prelude':'un--maybe'(erased, erased, fun () -> {'Idris.Prelude.Left', {'Idris.Erlang.System.File.FileReadError'}} end, fun () -> fun (V26) -> {'Idris.Prelude.Right', 'Idris.Builtin':'un--fst'(erased, erased, V26)} end end, 'Idris.Prelude':'un--strUncons'(V25)) end(E10);
																																					_ -> erlang:throw("Error: Unreachable branch")
																																				      end
																																			      end(E8, E9);
																																			  _ -> erlang:throw("Error: Unreachable branch")
																																		...
																																		fun (V27) -> 'Idris.Erlang.Data.Decode':'un--tuple2'(erased, erased, fun (V28) -> 'Idris.Erlang.Data.Decode':'un--exact'(erased, {'Idris.Erlang.Data.ETErlAtom'}, ok, V28) end, fun (V29) -> 'Idris.Erlang.Data.Decode':'un--charlist'(V29) end, V27) end, V21)
																									   end,
																									   fun (V30) -> 'Idris.Erlang.Data.Decode':'dn--un--<|>_Alternative__ErlDecoder'(erased, 'Idris.Prelude':'un--*>'(erased, erased, erased, {'Idris.Prelude.dn--un--__mkApplicative', fun (V31) -> fun (V32) -> fun (V33) -> fun (V34) -> fun (V35) -> 'Idris.Erlang.Data.Decode':'dn--un--map_Functor__ErlDecoder'(erased, erased, V33, V34, V35) end end end end end, fun (V36) -> fun (V37) -> fun (V38) -> 'Idris.Erlang.Data.Decode':'dn--un--pure_Applicative__ErlDecoder'(erased, V37, V38) end end end, fun (V39) -> fun (V40) -> fun (V41) -> fun (V42) -> fun (V43) -> 'Idris.Erlang.Data.Decode':'dn--un--<*>_Applicative__ErlDecoder'(erased, erased, V41, V42, V43) end end end end end}, fun (V44) -> 'Idris.Erlang.Data.Decode':'un--exact'(erased, {'Idris.Erlang.Data.ETErlAtom'}, eof, V44) end, fun (V45) -> 'Idris.Erlang.Data.Decode':'dn--un--pure_Applicative__ErlDecoder'(erased, {'Idris.Prelude.Left', {'Idris.Erlang.System.File.FileReadError'}}, V45) end), fun (V46) -> 'Idris.Erlang.Data.Decode':'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V47) -> {'Idris.Prelude.Left', V47} end, fun (V48) -> 'un--error'(V48) end, V46) end, V30) end, V20)
																  end,
																  V11))
							      end(E5, E6, E7);
							  _ -> erlang:throw("Error: Unreachable branch")
		  ...
		  (((V6(erased))(erased))(case V1 of
					    ...
					    _ -> erlang:throw("Error: Unreachable branch")
							...
							'Idris.Erlang.Data.Decode':'un--erlDecodeDef'(erased, erased, {'Idris.Erlang.Data.ETErlTerm'},
												      ...
												      fun (V20) ->
													      'Idris.Erlang.Data.Decode':'dn--un--<|>_Alternative__ErlDecoder'(erased, 'Idris.Prelude':'un--*>'(erased, erased, erased, {'Idris.Prelude.dn--un--__mkApplicative', fun (V21) -> fun (V22) -> fun (V23) -> fun (V24) -> fun (V25) -> 'Idris.Erlang.Data.Decode':'dn--un--map_Functor__ErlDecoder'(erased, erased, V23, V24, V25) end end end end end, fun (V26) -> fun (V27) -> fun (V28) -> 'Idris.Erlang.Data.Decode':'dn--un--pure_Applicative__ErlDecoder'(erased, V27, V28) end end end, fun (V29) -> fun (V30) -> fun (V31) -> fun (V32) -> fun (V33) -> 'Idris.Erlang.Data.Decode':'dn--un--<*>_Applicative__ErlDecoder'(erased, erased, V31, V32, V33) end end end end end}, fun (V34) -> 'Idris.Erlang.Data.Decode':'un--tuple2'(erased, erased, fun (V35) -> 'Idris.Erlang.Data.Decode':'un--exact'(erased, {'Idris.Erlang.Data.ETErlAtom'}, ok, V35) end, fun (V36) -> 'Idris.Erlang.Data.Decode':'un--any'(V36) end, V34) end, fun (V37) -> 'Idris.Erlang.Data.Decode':'dn--un--pure_Applicative__ErlDecoder'(erased, 'nested--3436-1229--in--un--scanBack'(erased, V1, V2), V37) end),
																					       fun (V38) ->
																						       'Idris.Erlang.Data.Decode':'dn--un--<|>_Alternative__ErlDecoder'(erased,
...
'un--chmodRaw'(V0, V1, V2, V3) ->
	...
	of
	  ...
	  fun (V6, V7, V8) ->
		  (((V7(erased))(erased))(case V1 of
					    {'Idris.Prelude.dn--un--__mkHasIO', E3, E4} -> fun (V9, V10) -> (V10(erased))(fun (V11) -> erlang:apply(file, change_mode, [unicode:characters_to_binary(V2), V3]) end) end(E3, E4);
					    _ -> erlang:throw("Error: Unreachable branch")
					  end))(fun (V12) ->
							case case case V1 of
								    {'Idris.Prelude.dn--un--__mkHasIO', E11, E12} -> fun (V13, V14) -> V13 end(E11, E12);
