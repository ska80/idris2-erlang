...
-export(['case--executeExpr-3899'/5, 'case--genCompdef-3246'/6, 'case--writeErlangModule-3168'/11, 'case--writeErlangModule-3091'/15, 'case--writeErlangModule-3005'/7, 'case--genExports-2948'/5, 'case--case block in getCompileExpr-2885'/6, 'case--getCompileExpr-2873'/4, 'case--getExports-2829'/2, 'case--case block in defsPerModule-2763'/6, 'case--defsPerModule-2747'/3, 'case--defsPerModule,extractModuleName-2704'/4, 'case--groupBy-2660'/6, 'case--generateErlCmd-2568'/4, 'nested--10932-2795--in--un--parseExport\''/3, 'nested--10821-2690--in--un--extractModuleName'/3, 'nested--10569-2458--in--un--escapeComponent'/2, 'nested--10569-2457--in--un--escapeChar'/2, 'un--writeErlangModule'/5, 'un--splitNamespaceInfo'/2, 'un--runProgramCmd'/3, 'un--pmapErlFun'/0, 'un--parseExport'/1, 'un--groupBy'/3, 'un--getExports'/1, 'un--getCompileExpr'/3, 'un--generateErlCmd'/4, 'un--genModule'/1, 'un--genExports'/5, 'un--genCompdef'/2, 'un--findErlangExecutable'/1, 'un--executeExpr'/3, 'un--evalErlangCmd'/2, 'un--escapeCmd'/1, 'un--defsPerModule'/2, 'un--defLine'/0, 'un--concatNamespaceInfo'/3, 'un--compileLibrary'/5, 'un--compileExpr'/6, 'un--compileAbstrCmd'/3, 'un--codegenErlang'/0]).

'case--executeExpr-3899'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--genCompdef-3246'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--writeErlangModule-3168'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      0 ->
...
'case--writeErlangModule-3091'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14) ->
    case V14 of
...
'case--writeErlangModule-3005'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'case--genExports-2948'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--case block in getCompileExpr-2885'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--getCompileExpr-2873'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V4) ->
		  begin
		    V5 = {'Idris.Prelude.Just', V4},
		    'case--case block in getCompileExpr-2885'(V0, V1, V2, V4, V5,
							      case V4 of
...
'case--defsPerModule,extractModuleName-2704'(V0, V1, V2, V3) ->
    case V3 of
...
'nested--10932-2795--in--un--parseExport\''(V0, V1, V2) ->
    case V2 of
      [E0 | E1] ->
	  fun (V3, V4) ->
		  case V3 of
...
'nested--10821-2690--in--un--extractModuleName'(V0, V1, V2) -> 'case--defsPerModule,extractModuleName-2704'(erased, V1, V2, 'Idris.Prelude':'dn--un--map_Functor__Maybe'(erased, erased, fun (V3) -> 'Idris.Builtin':'un--fst'(erased, erased, V3) end, 'Idris.Data.List':'un--head\''(erased, V2))).

'nested--10569-2458--in--un--escapeComponent'(V0, V1) -> 'Idris.Prelude.Strings':'un--++'(<<"'"/utf8>>, 'Idris.Prelude.Strings':'un--++'(('Idris.Prelude':'un--concat'(erased, erased, {'Idris.Builtin.MkPair', {'Idris.Prelude.dn--un--__mkFoldable', fun (V2) -> fun (V3) -> fun (V4) -> fun (V5) -> fun (V6) -> 'Idris.Prelude':'dn--un--foldr_Foldable__List'(erased, erased, V4, V5, V6) end end end end end, fun (V7) -> fun (V8) -> fun (V9) -> fun (V10) -> fun (V11) -> 'Idris.Prelude':'dn--un--foldl_Foldable__List'(erased, erased, V9, V10, V11) end end end end end}, {'Idris.Prelude.dn--un--__mkMonoid', fun (V12) -> fun (V13) -> 'Idris.Prelude':'dn--un--<+>_Semigroup__String'(V12, V13) end end, 'Idris.Prelude':'dn--un--neutral_Monoid__String'()}}))('Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V14) -> 'nested--10569-2457--in--un--escapeChar'(V0, V14) end, 'Idris.Prelude':'un--unpack'(V1))), <<"'"/utf8>>)).

'nested--10569-2457--in--un--escapeChar'(V0, V1) ->
    case V1 of
      $' -> <<"'\"'\"'"/utf8>>;
...
'un--writeErlangModule'(V0, V1, V2, V3, V4) ->
    case V4 of
	  ...
	  fun (V5, V6) ->
		  begin
		    V7 = 'case--writeErlangModule-3005'(V5, V6, V3, V2, V1, V0, V5),
		    begin
				...
				case V26 of
				  ...
				  {'Idris.Prelude.Right', E3} ->
				      fun (V28) ->
						...
						begin
						  V34 = 'case--writeErlangModule-3168'(V5, V6, V3, V2, V1, V0, V7, V21, V28, V29,
...
'un--parseExport'(V0) ->
    case V0 of
      {'Idris.Builtin.MkPair', E0, E1} -> fun (V1, V2) -> 'Idris.Prelude':'dn--un--map_Functor__Maybe'(erased, erased, fun (V3) -> {'Idris.Core.Name.NS', V1, {'Idris.Core.Name.UN', V3}} end, 'nested--10932-2795--in--un--parseExport\''(V1, V2, 'Idris.Data.Strings':'un--words'(V2))) end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
...
'un--groupBy'(V0, V1, V2) ->
    case V2 of
      [] -> [];
      [E0 | E1] -> fun (V3, V4) -> begin V5 = [V3 | V4], 'case--groupBy-2660'(erased, V3, V4, V5, V1, 'Idris.Data.List':'un--partition'(erased, V1(V3), V5)) end end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
				    ...
				    case V62 of
					  ...
					  fun (V63) ->
						  begin
						    ...
						    ('case--case block in getCompileExpr-2885'(V1, V0, V33, V63, V64,
											       case V63 of
...
'un--executeExpr'(V0, V1, V2) ->
    begin
      ...
      fun (V4) ->
	      begin
		V5 = ('Idris.Compiler.Erlang.Erlang.MainEntrypoint':'un--build'(V0, 'case--executeExpr-3899'(V2, V1, V0, V3, 'Idris.Compiler.Erlang.Opts':'un--defaultOpts'()), V2, V1, V1, V3))(V4),
		case V5 of
		  {'Idris.Prelude.Left', E0} -> fun (V6) -> {'Idris.Prelude.Left', V6} end(E0);
		  {'Idris.Prelude.Right', E1} ->
		      fun (V7) ->
...
'un--escapeCmd'(V0) -> 'Idris.Data.Strings':'un--unwords'('Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V1) -> 'nested--10569-2458--in--un--escapeComponent'(V0, V1) end, V0)).
...
'un--defsPerModule'(V0, V1) ->
    begin
      V8 = 'un--groupBy'(erased,
			 ...
			 V1),
      'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V9) -> 'nested--10821-2690--in--un--extractModuleName'(erased, V1, V9) end, V8)
    end.
