	  ...
	  fun (V19) ->
		  begin
		    ...
		    case V48 of
			  ...
			  fun (V50) ->
				  begin
				    V52 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V51) -> 'nested--10550-1646--in--un--showFld'(V0, V1, V2, V51) end, V0))(V19),
				    case V52 of
								  ...
								  fun (V32) ->
									  begin
									    ...
									    case V37 of
										  ...
										  fun (V39) ->
											  begin
											    V42 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V40) -> 'nested--9605-824--in--un--useArg'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V40) end, 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V41) -> 'Idris.Builtin':'un--fst'(erased, erased, V41) end, V29)))(V14),
											    case V42 of
...
'nested--9605-824--in--un--useArg'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V10, V11) ->
		  case V11 of
		    {'Idris.Core.CompileExpr.CFFun', E2, E3} -> fun (V12, V13) -> 'nested--9605-823--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, 'Idris.Compiler.Scheme.Common':'un--schName'(V10), [V12], V13) end(E2, E3);
...
'nested--10550-1646--in--un--showFld'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V4, V5) ->
		  fun (V6) ->
...
'nested--9605-822--in--un--notWorld'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> 1 end();
      _ -> 0
    end.

'nested--9605-819--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      [] -> [];
      [E0 | E1] ->
	  fun (V11, V12) ->
		  case V11 of
		    {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> [{'Idris.Prelude.Nothing'} | 'nested--9605-819--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V12)] end();
		    _ -> [{'Idris.Prelude.Just', {'Idris.Builtin.MkPair', 'Idris.Prelude.Strings':'un--++'(<<"cb"/utf8>>, 'Idris.Prelude':'dn--un--show_Show__Int'(V9)), V11}} | 'nested--9605-819--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, (V9 + 1) rem 9223372036854775808, V12)]
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--9605-821--in--un--mkFun'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11) -> begin V12 = 'nested--9605-819--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, 0, V9), 'Idris.Prelude.Strings':'un--++'(<<"(lambda ("/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Core.Name':'un--showSep'(<<" "/utf8>>, 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V13) -> 'Idris.Builtin':'un--fst'(erased, erased, V13) end, 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V14) -> V14 end, V12))), 'Idris.Prelude.Strings':'un--++'(<<") "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--9605-820--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V11, V12), <<")"/utf8>>)))) end.

'nested--9419-649--in--un--funTySpec'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Core.CompileExpr.CFFun', E4, E5} ->
	  fun (V5, V6) ->
		  case V5 of
		    {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> 'nested--9419-649--in--un--funTySpec'(V0, V1, V2, V3, V6) end();
		    _ -> 'nested--9419-649--in--un--funTySpec'(V0, V1, V2, [V5 | V3], V6)
		  end
	  end(E4, E5);
      _ ->
	  fun (V7) ->
...
'nested--9605-823--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11) ->
    case V11 of
      {'Idris.Core.CompileExpr.CFFun', E4, E5} -> fun (V12, V13) -> 'nested--9605-823--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, [V12 | V10], V13) end(E4, E5);
      _ ->
	  begin
	    V14 = 'Idris.Data.List':'un--reverse'(erased, V10),
	    fun (V15) ->
		    begin
		      V18 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V16) -> 'un--cftySpec'(V4, V16) end, 'Idris.Data.List':'un--filter'(erased, fun (V17) -> 'nested--9605-822--in--un--notWorld'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V17) end, V14)))(V15),
		      case V18 of
			...
			{'Idris.Prelude.Right', E1} ->
			    fun (V20) ->
					...
					{'Idris.Prelude.Right', E3} -> fun (V23) -> {'Idris.Prelude.Right', 'nested--9605-821--in--un--mkFun'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V14, V11, V9)} end(E3);
					_ -> erlang:throw("Error: Unreachable branch")
				      end
				    end
			    end(E1);
...
'nested--9605-820--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      [] -> V9;
      [E0 | E1] ->
	  fun (V11, V12) ->
		  case V11 of
		    {'Idris.Prelude.Nothing'} -> fun () -> 'nested--9605-820--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V8, 'Idris.Prelude.Strings':'un--++'(<<"("/utf8>>, 'Idris.Prelude.Strings':'un--++'(V9, <<" #f)"/utf8>>)), V12) end();
		    {'Idris.Prelude.Just', E2} ->
			fun (V13) ->
				case V13 of
				  {'Idris.Builtin.MkPair', E3, E4} -> fun (V14, V15) -> 'nested--9605-820--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V8, 'Idris.Prelude.Strings':'un--++'(<<"("/utf8>>, 'Idris.Prelude.Strings':'un--++'(V9, 'Idris.Prelude.Strings':'un--++'(<<" "/utf8>>, 'Idris.Prelude.Strings':'un--++'('un--cToRkt'(V15, V14), <<")"/utf8>>)))), V12) end(E3, E4);
				  _ -> erlang:throw("Error: Unreachable branch")
				end
			end(E2);
		    _ -> erlang:throw("Error: Unreachable branch")
...
'un--cftySpec'(V0, V1) ->
    case V1 of
      ...
      {'Idris.Core.CompileExpr.CFFun', E3, E4} -> fun (V15, V16) -> 'nested--9419-649--in--un--funTySpec'(V16, V15, V0, [V15], V16) end(E3, E4);
