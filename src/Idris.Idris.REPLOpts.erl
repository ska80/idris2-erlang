...
-export(['case--setCurrentElabSource-2883'/3, 'case--setSource-2791'/3, 'case--setMainFile-2757'/3, 'case--setOutput-2704'/3, 'nested--9490-2722--in--un--litStyle'/3, 'nested--9407-2648--in--un--litStyle'/4, 'nested--9585-2809--in--un--findLine'/4, 'un--setSource'/3, 'un--setOutput'/3, 'un--setMainFile'/3, 'un--setCurrentElabSource'/3, 'un--replFC'/0, 'un--getSourceLine'/3, 'un--getSource'/2, 'un--getOutput'/2, 'un--getLitStyle'/2, 'un--getCurrentElabSource'/2, 'un--getCodegen'/3, 'un--defaultOpts'/3]).

'case--setCurrentElabSource-2883'(V0, V1, V2) ->
    case V2 of
...
'case--setMainFile-2757'(V0, V1, V2) ->
    case V2 of
      {'Idris.Idris.REPLOpts.MkREPLOpts', E0, E1, E2, E3, E4, E5, E6, E7, E8, E9} -> fun (V3, V4, V5, V6, V7, V8, V9, V10, V11, V12) -> {'Idris.Idris.REPLOpts.MkREPLOpts', V3, V4, V0, 'nested--9490-2722--in--un--litStyle'(V0, V1, V0), V7, V8, V9, V10, V11, V12} end(E0, E1, E2, E3, E4, E5, E6, E7, E8, E9);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--setOutput-2704'(V0, V1, V2) ->
    case V2 of
...
'nested--9490-2722--in--un--litStyle'(V0, V1, V2) ->
    case V2 of
...
'nested--9407-2648--in--un--litStyle'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Prelude.Nothing'} -> fun () -> {'Idris.Prelude.Nothing'} end();
...
'nested--9585-2809--in--un--findLine'(V0, V1, V2, V3) ->
    case V2 of
      0 ->
	  case V3 of
	  ...
	  begin
	    V6 = V2 - 1,
	    case V3 of
	      [E0 | E1] -> fun (V7, V8) -> 'nested--9585-2809--in--un--findLine'(V0, V1, V6, V8) end(E0, E1);
	      _ ->
		  case V3 of
		    [] -> {'Idris.Prelude.Nothing'};
		    _ -> erlang:throw("Error: Unreachable branch")
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V33) ->
		    begin
		      V71 = ('Idris.Erlang.Data.IORef':'un--writeIORef'(erased, erased, {'Idris.Prelude.dn--un--__mkHasIO', {'Idris.Prelude.dn--un--__mkMonad', {'Idris.Prelude.dn--un--__mkApplicative', fun (V34) -> fun (V35) -> fun (V36) -> fun (V37) -> fun (V38) -> 'Idris.Prelude':'dn--un--map_Functor__IO'(erased, erased, V36, V37, V38) end end end end end, fun (V39) -> fun (V40) -> fun (V41) -> V40 end end end, fun (V42) -> fun (V43) -> fun (V44) -> fun (V45) -> fun (V46) -> begin V47 = V44(V46), begin V48 = V45(V46), V47(V48) end end end end end end end}, fun (V49) -> fun (V50) -> fun (V51) -> fun (V52) -> fun (V53) -> begin V54 = V51(V53), (V52(V54))(V53) end end end end end end, fun (V55) -> fun (V56) -> fun (V57) -> begin V58 = V56(V57), V58(V57) end end end end}, fun (V59) -> fun (V60) -> V60 end end}, V0,
									case V33 of
									  {'Idris.Idris.REPLOpts.MkREPLOpts', E2, E3, E4, E5, E6, E7, E8, E9, E10, E11} -> fun (V61, V62, V63, V64, V65, V66, V67, V68, V69, V70) -> {'Idris.Idris.REPLOpts.MkREPLOpts', V61, V62, V1, 'nested--9490-2722--in--un--litStyle'(V1, V0, V1), V65, V66, V67, V68, V69, V70} end(E2, E3, E4, E5, E6, E7, E8, E9, E10, E11);
									  _ -> erlang:throw("Error: Unreachable branch")
									end))(V2),
		      {'Idris.Prelude.Right', V71}
		    end
...
'un--getSourceLine'(V0, V1, V2) ->
	...
	{'Idris.Prelude.Right', E1} -> fun (V5) -> {'Idris.Prelude.Right', 'nested--9585-2809--in--un--findLine'(V1, V0, 'Idris.Prelude':'dn--un--cast_Cast__Int_Integer'('Idris.Prelude':'dn--un---_Neg__Int'(V1, 1)), 'Idris.Data.Strings':'un--lines'(V5))} end(E1);
	_ -> erlang:throw("Error: Unreachable branch")
      end
    end.
...
'un--defaultOpts'(V0, V1, V2) -> {'Idris.Idris.REPLOpts.MkREPLOpts', 1, {'Idris.Idris.Syntax.NormaliseAll'}, V0, 'nested--9407-2648--in--un--litStyle'(V2, V1, V0, V0), <<""/utf8>>, <<"vim"/utf8>>, {'Idris.Prelude.Nothing'}, V1, <<""/utf8>>, V2}.