...
-export(['case--executeExpr-2434'/4, 'case--compileExpr-2365'/13, 'case--compileToSCM-2221'/17, 'case--schFgnDef-1975'/14, 'case--mkStruct-1830'/6, 'case--useCC-1571'/8, 'case--schemeCall-1523'/5, 'case--cCall-1415'/19, 'case--cCall,buildArg-1238'/14, 'case--cCall,buildCWrapperDefs-1033'/18, 'case--showGambitChar-273'/2, 'nested--10382-1783--in--un--showFld'/4, 'nested--9484-943--in--un--replaceChar'/11, 'nested--9484-941--in--un--mkNs'/10, 'nested--9484-946--in--un--mkFun'/11, 'nested--9325-824--in--un--funTySpec'/5, 'nested--9250-747--in--un--funTySpec'/5, 'nested--10140-1563--in--un--fnWrapName'/9, 'nested--9484-947--in--un--callback'/11, 'nested--9484-944--in--un--buildCWrapperDefs'/9, 'nested--9484-945--in--un--buildCFunWrapDeclaration'/11, 'nested--9484-948--in--un--buildArg'/9, 'nested--9484-942--in--un--applyLams'/10, 'un--useCC'/6, 'un--showGambitString'/1, 'un--showGambitChar'/1, 'un--schemeCall'/4, 'un--schHeader'/0, 'un--schFgnDef'/6, 'un--notWorld'/1, 'un--mkStruct'/2, 'un--mkArgs'/2, 'un--handleRet'/2, 'un--getFgnCall'/4, 'un--gambitString'/1, 'un--gambitPrim'/3, 'un--findGSC'/1, 'un--executeExpr'/4, 'un--compileToSCM'/4, 'un--compileLibrary'/5, 'un--compileExpr'/5, 'un--codegenGambit'/0, 'un--cftySpec'/2, 'un--cType'/2, 'un--cCall'/9]).
	  ...
	  fun (V19) ->
		  begin
		    ...
		    case V48 of
			  ...
			  fun (V50) ->
				  begin
				    V52 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V51) -> 'nested--10382-1783--in--un--showFld'(V0, V1, V2, V51) end, V0))(V19),
				    case V52 of
						    ...
						    case V19 of
							  ...
							  fun (V20, V21) ->
								  case V21 of
									...
									fun (V22) ->
										begin
										  V24 = 'un--cCall'(V6, V5, V4, V18, fun (V23) -> 'nested--10140-1563--in--un--fnWrapName'(V0, V1, V2, V3, V4, V5, V6, V18, V23) end, V20, V3, V2, V22),
										  case V24 of
									...
									fun (V27, V28) ->
										case V28 of
										  [] ->
										      fun (V29) ->
											      begin
												V31 = 'un--cCall'(V6, V5, V4, V18, fun (V30) -> 'nested--10140-1563--in--un--fnWrapName'(V0, V1, V2, V3, V4, V5, V6, V18, V30) end, V20, V3, V2, V29),
												case V31 of
...
'nested--10382-1783--in--un--showFld'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V4, V5) ->
		  fun (V6) ->
...
'nested--9484-943--in--un--replaceChar'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) -> 'Idris.Prelude':'un--pack'('Idris.Data.List':'un--replaceOn'(erased, {'Idris.Prelude.dn--un--__mkEq', fun (V11) -> fun (V12) -> 'Idris.Prelude':'dn--un--==_Eq__Char'(V11, V12) end end, fun (V13) -> fun (V14) -> 'Idris.Prelude':'dn--un--/=_Eq__Char'(V13, V14) end end}, V8, V9, 'Idris.Prelude':'un--unpack'(V10))).

'nested--9484-941--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      [] -> [];
      [E0 | E1] ->
	  fun (V10, V11) ->
		  case V10 of
		    {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> [{'Idris.Prelude.Nothing'} | 'nested--9484-941--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V11)] end();
		    _ -> [{'Idris.Prelude.Just', 'Idris.Prelude.Strings':'un--++'(<<"cb"/utf8>>, 'Idris.Prelude':'dn--un--show_Show__Int'(V8))} | 'nested--9484-941--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, (V8 + 1) rem 9223372036854775808, V11)]
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--9484-946--in--un--mkFun'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) -> begin V11 = 'nested--9484-941--in--un--mkNs'(V0, V1, V2, V3, V4, V5, V6, V7, 0, V8), 'Idris.Prelude.Strings':'un--++'(<<"(lambda ("/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Core.Name':'un--showSep'(<<" "/utf8>>, 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V12) -> V12 end, V11)), 'Idris.Prelude.Strings':'un--++'(<<") "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--9484-942--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V10, V11), <<")"/utf8>>)))) end.

'nested--9325-824--in--un--funTySpec'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Core.CompileExpr.CFFun', E4, E5} ->
	  fun (V5, V6) ->
		  case V5 of
		    {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> 'nested--9325-824--in--un--funTySpec'(V0, V1, V2, V3, V6) end();
		    _ -> 'nested--9325-824--in--un--funTySpec'(V0, V1, V2, [V5 | V3], V6)
		  end
	  end(E4, E5);
      _ ->
	  fun (V7) ->
...
'nested--9250-747--in--un--funTySpec'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Core.CompileExpr.CFFun', E4, E5} ->
	  fun (V5, V6) ->
		  case V5 of
		    {'Idris.Core.CompileExpr.CFWorld'} -> fun () -> 'nested--9250-747--in--un--funTySpec'(V0, V1, V2, V3, V6) end();
		    _ -> 'nested--9250-747--in--un--funTySpec'(V0, V1, V2, [V5 | V3], V6)
		  end
	  end(E4, E5);
      _ ->
	  fun (V7) ->
...
'nested--10140-1563--in--un--fnWrapName'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> 'Idris.Prelude.Strings':'un--++'(V8, 'Idris.Prelude.Strings':'un--++'(<<"-"/utf8>>, 'Idris.Prelude.Strings':'un--++'(V7, <<"-cFunWrap"/utf8>>))).

'nested--9484-947--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    case V10 of
      {'Idris.Core.CompileExpr.CFFun', E4, E5} -> fun (V11, V12) -> 'nested--9484-947--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V8, [V11 | V9], V12) end(E4, E5);
      _ ->
	  begin
	    ...
	    fun (V14) ->
			...
			{'Idris.Prelude.Right', E1} ->
			    fun (V19) ->
					...
					{'Idris.Prelude.Right', E3} -> fun (V22) -> {'Idris.Prelude.Right', {'Idris.Builtin.MkPair', 'nested--9484-946--in--un--mkFun'(V0, V1, V2, V3, V4, V5, V6, V7, V13, V10, V8), {'Idris.Builtin.MkPair', V19, V22}}} end(E3);
					_ -> erlang:throw("Error: Unreachable branch")
				      end
				    end
			    end(E1);
			...
			fun (V11, V12) ->
				begin
				  ...
				  begin
				    ...
				    fun (V15) ->
					    begin
					      V16 = ('nested--9484-947--in--un--callback'(V0, V1, V2, V3, V4, V5, V6, V7, V13, [V11], V12))(V15),
					      case V16 of
...
'nested--9484-942--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      [] -> V8;
      [E0 | E1] ->
	  fun (V10, V11) ->
		  case V10 of
		    {'Idris.Prelude.Nothing'} -> fun () -> 'nested--9484-942--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, 'Idris.Prelude.Strings':'un--++'(<<"("/utf8>>, 'Idris.Prelude.Strings':'un--++'(V8, <<" #f)"/utf8>>)), V11) end();
		    {'Idris.Prelude.Just', E2} -> fun (V12) -> 'nested--9484-942--in--un--applyLams'(V0, V1, V2, V3, V4, V5, V6, V7, 'Idris.Prelude.Strings':'un--++'(<<"("/utf8>>, 'Idris.Prelude.Strings':'un--++'(V8, 'Idris.Prelude.Strings':'un--++'(<<" "/utf8>>, 'Idris.Prelude.Strings':'un--++'(V12, <<")"/utf8>>)))), V11) end(E2);
		    _ -> erlang:throw("Error: Unreachable branch")
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
...
'un--cftySpec'(V0, V1) ->
    case V1 of
      ...
      {'Idris.Core.CompileExpr.CFFun', E3, E4} -> fun (V13, V14) -> 'nested--9325-824--in--un--funTySpec'(V14, V13, V0, [V13], V14) end(E3, E4);
...
'un--cType'(V0, V1) ->
    case V1 of
      ...
      {'Idris.Core.CompileExpr.CFFun', E3, E4} -> fun (V12, V13) -> 'nested--9250-747--in--un--funTySpec'(V13, V12, V0, [V12], V13) end(E3, E4);
	...
	{'Idris.Prelude.Right', E1} ->
	    fun (V12) ->
			...
			{'Idris.Prelude.Right', E3} ->
			    fun (V15) ->
				    begin
				      V17 = ('Idris.Core.Core':'un--traverse'(erased, erased, fun (V16) -> 'nested--9484-948--in--un--buildArg'(V7, V6, V5, V4, V3, V2, V1, V0, V16) end, V6))(V8),
				      case V17 of
							...
							{'Idris.Prelude.Right', E7} ->
							    fun (V23) ->
									...
									{'Idris.Prelude.Right', E9} ->
									    fun (V26) ->
										    begin
										      V29 = 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V27) -> 'nested--9484-944--in--un--buildCWrapperDefs'(V7, V6, V5, V4, V3, V2, V1, V0, V27) end, 'Idris.Data.List':'un--mapMaybe'(erased, erased, fun (V28) -> 'Idris.Builtin':'un--snd'(erased, erased, V28) end, V19)),
										      begin
											V30 = 'nested--9484-945--in--un--buildCFunWrapDeclaration'(V7, V6, V5, V4, V3, V2, V1, V0, V3, V26, V23),
											begin
