...
'nested--5944-2221--in--un--writeAll'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
		  ...
		  fun (V10) ->
			  begin
			    ...
			    case V13 of
			      ...
			      {'Idris.Prelude.Right', E5} -> fun (V15) -> ('nested--5944-2221--in--un--writeAll'(erased, V1, V2, V3, V4, erased, V9))(V10) end(E5);
			      _ -> erlang:throw("Error: Unreachable branch")
			    end
			  end
		  end
...
'nested--5946-2249--in--un--readElems'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
	  ...
	  begin
	    ...
	    fun (V9) ->
			...
			{'Idris.Prelude.Right', E3} -> fun (V14) -> ('nested--5946-2249--in--un--readElems'(erased, V1, V2, V3, erased, {'Idris.Data.Vect.::', V14, V5}, V8))(V9) end(E3);
			_ -> erlang:throw("Error: Unreachable branch")
		      end
		    end
	    end
...
'nested--5859-2165--in--un--readElems'(V0, V1, V2, V3, V4) ->
    case V4 of
	  ...
	  begin
	    ...
	    fun (V7) ->
			...
			{'Idris.Prelude.Right', E3} -> fun (V12) -> ('nested--5859-2165--in--un--readElems'(erased, V1, V2, [V12 | V3], V6))(V7) end(E3);
			_ -> erlang:throw("Error: Unreachable branch")
		      end
		    end
	    end
...
'nested--5857-2128--in--un--length_aux'(V0, V1, V2, V3, V4, V5) ->
    case V4 of
      [] -> V5;
      [E0 | E1] -> fun (V6, V7) -> 'nested--5857-2128--in--un--length_aux'(erased, V1, V2, V3, V7, (1 + V5) rem 9223372036854775808) end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--5857-2129--in--un--TailRec_length'(V0, V1, V2, V3, V4) -> 'nested--5857-2128--in--un--length_aux'(erased, V1, V2, V3, V4, 0).
...
'dn--un--toBuf_TTC__(List $a)'(V0, V1, V2, V3, V4) ->
    begin
      V5 = 'dn--un--toBuf_TTC__Int'(V2, 'nested--5857-2129--in--un--TailRec_length'(erased, V1, V3, V2, V3), V4),
      case V5 of
...
'dn--un--toBuf_TTC__((Vect $n) $a)'(V0, V1, V2, V3, V4) -> 'nested--5944-2221--in--un--writeAll'(erased, V1, V2, V4, V3, erased, V4).
...
'dn--un--fromBuf_TTC__(List $a)'(V0, V1, V2, V3) ->
    begin
      ...
      case V4 of
	{'Idris.Prelude.Left', E0} -> fun (V5) -> {'Idris.Prelude.Left', V5} end(E0);
	{'Idris.Prelude.Right', E1} -> fun (V6) -> ('nested--5859-2165--in--un--readElems'(erased, V1, V2, [], 'Idris.Prelude':'dn--un--cast_Cast__Int_Integer'(V6)))(V3) end(E1);
	_ -> erlang:throw("Error: Unreachable branch")
      end
    end.

'dn--un--fromBuf_TTC__((Vect $n) $a)'(V0, V1, V2, V3) -> 'nested--5946-2249--in--un--readElems'(erased, V2, V3, V1, erased, {'Idris.Data.Vect.Nil'}, V1).
