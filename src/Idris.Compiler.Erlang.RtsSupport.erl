...
'nested--5342-1220--in--un--genHalt'(V0, V1, V2, V3, V4) -> 'un--genFunCall'(V3, <<"erlang"/utf8>>, <<"halt"/utf8>>, [{'Idris.Compiler.Erlang.ErlExpr.EInteger', V3, V4}]).

'nested--5254-1138--in--un--curry'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V6 of
	  ...
	  begin
	    ...
	    fun (V12) ->
			...
			{'Idris.Prelude.Right', E1} ->
			    fun (V15) ->
				    begin
				      V16 = ('nested--5254-1138--in--un--curry'(V0, V1, V2, V3, V4, V5, V11, V7, V8, [{'Idris.Compiler.Erlang.ErlExpr.ELocal', V5, V15} | V9]))(V12),
				      case V16 of
    ...
    case V1 of
	  ...
	  fun (V2, V3) ->
		  case V3 of
		    ...
		    _ -> 'un--genFunCall'(V0, <<"erlang"/utf8>>, <<"binary_to_atom"/utf8>>, [V1, {'Idris.Compiler.Erlang.ErlExpr.EAtom', V0, <<"utf8"/utf8>>}])
		  end
	  end(E0, E1);
      _ -> 'un--genFunCall'(V0, <<"erlang"/utf8>>, <<"binary_to_atom"/utf8>>, [V1, {'Idris.Compiler.Erlang.ErlExpr.EAtom', V0, <<"utf8"/utf8>>}])
    end.
...
'un--genUnicodeStringOp'(V0, V1, V2, V3) -> 'un--genBoolToInt'(V1, {'Idris.Compiler.Erlang.ErlExpr.EOp', V1, V0, V2, V3}).
...
'un--genUnicodeStringCons'(V0, V1, V2) -> begin V3 = 'un--genFunCall'(V0, <<"unicode"/utf8>>, <<"characters_to_binary"/utf8>>, ['un--genList'(V0, [V1])]), {'Idris.Compiler.Erlang.ErlExpr.EBinaryConcat', V0, V3, V2} end.

'un--genUnicodeStringAppend'(V0, V1, V2) -> {'Idris.Compiler.Erlang.ErlExpr.EBinaryConcat', V0, V1, V2}.
		...
		case V5 of
		  ...
		  {'Idris.Prelude.Right', E1} ->
		      fun (V7) ->
				...
				case V8 of
				  {'Idris.Prelude.Left', E2} -> fun (V9) -> {'Idris.Prelude.Left', V9} end(E2);
				  {'Idris.Prelude.Right', E3} -> fun (V10) -> begin V11 = {'Idris.Compiler.Erlang.ErlExpr.ESequence', V1, {'Idris.Data.Vect.::', V3, {'Idris.Data.Vect.::', 'un--genEscriptMain'(V1, V2), {'Idris.Data.Vect.::', 'nested--5342-1220--in--un--genHalt'(V2, V1, V0, V1, 0), {'Idris.Data.Vect.Nil'}}}}}, {'Idris.Prelude.Right', {'Idris.Compiler.Erlang.ErlExpr.ETryCatch', V1, V11, V7, {'Idris.Compiler.Erlang.ErlExpr.ELocal', V1, V7}, V10, {'Idris.Compiler.Erlang.ErlExpr.ESequence', V1, {'Idris.Data.Vect.::', 'un--genFunCall'(V1, <<"erlang"/utf8>>, <<"display"/utf8>>, [{'Idris.Compiler.Erlang.ErlExpr.ELocal', V1, V10}]), {'Idris.Data.Vect.::', 'nested--5342-1220--in--un--genHalt'(V2, V1, V0, V1, 127), {'Idris.Data.Vect.Nil'}}}}}} end end(E3);
				  _ -> erlang:throw("Error: Unreachable branch")
				end
			      end
		      end(E1);
...
'un--genCurry'(V0, V1, V2, V3, V4) -> 'nested--5254-1138--in--un--curry'(V4, V3, V2, V1, V0, V1, V2, V3, V4, []).
