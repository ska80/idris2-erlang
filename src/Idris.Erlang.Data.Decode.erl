...
-export(['case--fun5-2716'/7, 'case--fun4-2644'/6, 'case--fun3-2582'/5, 'case--fun2-2530'/4, 'case--fun1-2488'/3, 'case--fun0-2459'/2, 'case--case block in mapEntry-2349'/9, 'case--mapEntry-2296'/7, 'case--hList-2180'/5, 'case--list-2136'/3, 'case--tuple5-1982'/12, 'case--tuple4-1841'/10, 'case--tuple3-1728'/8, 'case--tuple2-1643'/6, 'case--tuple1-1586'/4, 'case--cons-1498'/6, 'case--exact-1286'/5, 'case--lazyAlt-1242'/4, 'case--erlDecodeDef-1130'/7, 'case--erlDecodeMay-1071'/6, 'case--case block in <|>-984'/6, 'case--<|>-947'/5, 'case-->>=-870'/7, 'nested--3177-2214--in--un--listHead'/1, 'dn--un--pure_Applicative__ErlDecoder'/3, 'dn--un--map_Functor__ErlDecoder'/5, 'dn--un--join_Monad__ErlDecoder'/3, 'dn--un--empty_Alternative__ErlDecoder'/2, 'dn--un--__Impl_Monad_ErlDecoder'/0, 'dn--un--__Impl_Functor_ErlDecoder'/5, 'dn--un--__Impl_Applicative_ErlDecoder'/0, 'dn--un--__Impl_Alternative_ErlDecoder'/0, 'dn--un-->>=_Monad__ErlDecoder'/5, 'dn--un--<|>_Alternative__ErlDecoder'/4, 'dn--un--<*>_Applicative__ErlDecoder'/5, 'un--tuple5'/11, 'un--tuple4'/9, 'un--tuple3'/7, 'un--tuple2'/5, 'un--tuple1'/3, 'un--tuple0'/1, 'un--string'/1, 'un--reference'/1, 'un--prim__erldecodeReference'/1, 'un--prim__erlMatchExact'/2, 'un--prim__erlDecodeTuple5'/1, 'un--prim__erlDecodeTuple4'/1, 'un--prim__erlDecodeTuple3'/1, 'un--prim__erlDecodeTuple2'/1, 'un--prim__erlDecodeTuple1'/1, 'un--prim__erlDecodeTuple0'/1, 'un--prim__erlDecodePort'/1, 'un--prim__erlDecodePid'/1, 'un--prim__erlDecodeNil'/1, 'un--prim__erlDecodeInteger'/1, 'un--prim__erlDecodeFun5'/6, 'un--prim__erlDecodeFun4'/5, 'un--prim__erlDecodeFun3'/4, 'un--prim__erlDecodeFun2'/3, 'un--prim__erlDecodeFun1'/2, 'un--prim__erlDecodeFun0'/1, 'un--prim__erlDecodeDouble'/1, 'un--prim__erlDecodeCons'/1, 'un--prim__erlDecodeCodepoint'/1, 'un--prim__erlDecodeBinary'/1, 'un--prim__erlDecodeAtom'/1, 'un--prim__erlDecodeAnyMap'/1, 'un--prim__erlDecodeAnyList'/1, 'un--port'/1, 'un--pid'/1, 'un--optional'/3, 'un--nil'/1, 'un--mapSubset'/2, 'un--mapEntry'/6, 'un--list'/3, 'un--lazyAlt'/4, 'un--integer'/1, 'un--hList'/2, 'un--fun5'/6, 'un--fun4'/5, 'un--fun3'/4, 'un--fun2'/3, 'un--fun1'/2, 'un--fun0'/1, 'un--fail'/3, 'un--exact'/4, 'un--erlDecodeMay'/5, 'un--erlDecodeDef'/6, 'un--erlDecode'/5, 'un--double'/1, 'un--cons'/5, 'un--codepoint'/1, 'un--charlist'/1, 'un--binary'/1, 'un--atom'/1, 'un--anyMap'/1, 'un--anyList'/1, 'un--any'/1, 'un--:='/4]).

'case--fun5-2716'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'case--fun4-2644'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V6) ->
		  case V6 of
...
'case--case block in mapEntry-2349'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    case V8 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V9) ->
		  case V9 of
...
'case--mapEntry-2296'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V7) ->
		  begin
		    V9 = 'Idris.PrimIO':'un--unsafePerformIO'(erased, fun (V8) -> erlang:apply(maps, find, [V3, V7]) end),
		    'case--case block in mapEntry-2349'(erased, erased, V2, V4, V5, V3, V7, V9,
							case V9 of
...
'case--hList-2180'(V0, V1, V2, V3, V4) ->
    case V4 of
      [E0 | E1] -> fun (V5, V6) -> [V5 | V6] end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--list-2136'(V0, V1, V2) ->
    case V2 of
      [E0 | E1] -> fun (V3, V4) -> [V3 | V4] end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--tuple5-1982'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11) ->
    case V11 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V12) ->
		  case V12 of
...
'case--tuple4-1841'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) ->
    case V9 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V10) ->
		  case V10 of
...
'case--tuple3-1728'(V0, V1, V2, V3, V4, V5, V6, V7) ->
    case V7 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V8) ->
		  case V8 of
...
'case--tuple2-1643'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V6) ->
		  case V6 of
...
'case--cons-1498'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      {'Idris.Prelude.Just', E0} ->
	  fun (V6) ->
		  case V6 of
...
'case--exact-1286'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--erlDecodeDef-1130'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
...
'case--erlDecodeMay-1071'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--case block in <|>-984'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--<|>-947'(V0, V1, V2, V3, V4) ->
    case V4 of
      {'Idris.Prelude.Right', E0} -> fun (V5) -> {'Idris.Prelude.Right', V5} end(E0);
      {'Idris.Prelude.Left', E1} -> fun (V6) -> 'case--case block in <|>-984'(erased, V1, V2, V3, V6, V2(V3)) end(E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case-->>=-870'(V0, V1, V2, V3, V4, V5, V6) -> V6(V4).

'nested--3177-2214--in--un--listHead'(V0) -> 'un--lazyAlt'(erased, fun (V1) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V2) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V2) end, fun (V3) -> 'un--codepoint'(V3) end, V1) end, fun () -> fun (V4) -> 'un--lazyAlt'(erased, fun (V5) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V6) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V6) end, fun (V7) -> 'un--binary'(V7) end, V5) end, fun () -> fun (V8) -> 'un--lazyAlt'(erased, fun (V9) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V10) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V10) end, fun (V11) -> 'un--nil'(V11) end, V9) end, fun () -> fun (V12) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V13) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V13) end, fun (V14) -> 'un--cons'(erased, erased, fun (V15) -> 'nested--3177-2214--in--un--listHead'(V15) end, fun (V16) -> 'un--string'(V16) end, V14) end, V12) end end, V8) end end, V4) end end, V0).
...
'dn--un-->>=_Monad__ErlDecoder'(V0, V1, V2, V3, V4) -> 'Idris.Prelude':'dn--un-->>=_Monad__(Either $e)'(erased, erased, erased, V2(V4), fun (V5) -> 'case-->>=-870'(erased, erased, V2, V3, V4, V5, V3(V5)) end).

'dn--un--<|>_Alternative__ErlDecoder'(V0, V1, V2, V3) -> 'case--<|>-947'(erased, V1, V2, V3, V1(V3)).
...
'un--tuple5'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10) ->
    'case--tuple5-1982'(erased, erased, erased, erased, erased, V5, V6, V7, V8, V9, V10,
			case V10 of
...
'un--tuple4'(V0, V1, V2, V3, V4, V5, V6, V7, V8) ->
    'case--tuple4-1841'(erased, erased, erased, erased, V4, V5, V6, V7, V8,
			case V8 of
...
'un--tuple3'(V0, V1, V2, V3, V4, V5, V6) ->
    'case--tuple3-1728'(erased, erased, erased, V3, V4, V5, V6,
			case V6 of
...
'un--tuple2'(V0, V1, V2, V3, V4) ->
    'case--tuple2-1643'(erased, erased, V2, V3, V4,
			case V4 of
...
'un--string'(V0) -> 'un--lazyAlt'(erased, fun (V1) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V2) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V2) end, fun (V3) -> 'un--binary'(V3) end, V1) end, fun () -> fun (V4) -> 'un--lazyAlt'(erased, fun (V5) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V6) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V6) end, fun (V7) -> 'un--nil'(V7) end, V5) end, fun () -> fun (V8) -> 'dn--un--map_Functor__ErlDecoder'(erased, erased, fun (V9) -> 'Idris.Builtin':'un--believe_me'(erased, erased, V9) end, fun (V10) -> 'un--cons'(erased, erased, fun (V11) -> 'nested--3177-2214--in--un--listHead'(V11) end, fun (V12) -> 'un--string'(V12) end, V10) end, V8) end end, V4) end end, V0).
...
'un--mapEntry'(V0, V1, V2, V3, V4, V5) ->
    'case--mapEntry-2296'(erased, erased, V2, V3, V4, V5,
			  case V5 of
...
'un--fun5'(V0, V1, V2, V3, V4, V5) ->
    'case--fun5-2716'(V4, V3, V2, V1, V0, V5,
		      case V5 of
			E0 when erlang:is_function(E0, 5) -> fun (V6) -> {'Idris.Prelude.Just', V6} end(E0);
			_ -> {'Idris.Prelude.Nothing'}
		      end).
...
'un--exact'(V0, V1, V2, V3) ->
    'case--exact-1286'(erased, V1, V2, V3,
...
'un--erlDecodeMay'(V0, V1, V2, V3, V4) -> 'case--erlDecodeMay-1071'(erased, erased, V2, V4, V3, 'un--erlDecode'(erased, erased, V2, V3, V4)).

'un--erlDecodeDef'(V0, V1, V2, V3, V4, V5) -> 'case--erlDecodeDef-1130'(erased, erased, V2, V5, V4, V3, 'un--erlDecode'(erased, erased, V2, V4, V5)).
...
'un--cons'(V0, V1, V2, V3, V4) ->
    'case--cons-1498'(erased, erased, V2, V3, V4,
		      case V4 of
			[E0 | E1] -> fun (V7) -> {'Idris.Prelude.Just', V7} end(fun (V5, V6) -> [V5 | V6] end(E0, E1));
			_ -> {'Idris.Prelude.Nothing'}
		      end).
