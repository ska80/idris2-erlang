-module('Idris.Idris.Package.PkgDesc').

-compile(no_auto_import).

-export(['un--sourcedir'/1, 'un--preinstall'/1, 'un--preclean'/1, 'un--prebuild'/1, 'un--postinstall'/1, 'un--postclean'/1, 'un--postbuild'/1, 'un--outputdir'/1, 'un--options'/1, 'un--name'/1, 'un--modules'/1, 'un--mainmod'/1, 'un--library'/1, 'un--executable'/1, 'un--depends'/1, 'un--builddir'/1]).
