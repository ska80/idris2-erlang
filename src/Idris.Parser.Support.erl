...
-export(['case--case block in getCharLit-3552'/3, 'case--getCharLit-3530'/3, 'case--case block in escape\'-3431'/4, 'case--case block in case block in escape\'-3363'/6, 'case--case block in escape\'-3313'/6, 'case--escape\'-3281'/2, 'case--escape\'-3229'/2, 'case--escape\'-3137'/2, 'nested--4234-3187--in--un--toOct'/3, 'nested--4234-3095--in--un--toHex'/3, 'dn--un--show_Show__(ParseError $tok)'/3, 'dn--un--showPrec_Show__(ParseError $tok)'/4, 'dn--un--__Impl_Show_(ParseError $tok)'/2, 'un--toGenericParsingError'/2, 'un--oct'/1, 'un--hex'/1, 'un--getEsc'/1, 'un--getCharLit'/1, 'un--escape\''/1, 'un--escape'/1, 'un--dec'/1]).

'case--case block in getCharLit-3552'(V0, V1, V2) ->
    case V2 of
...
'case--getCharLit-3530'(V0, V1, V2) ->
    case V2 of
      0 -> {'Idris.Prelude.Just', erlang:hd(string:next_grapheme(V1))};
      1 -> 'case--case block in getCharLit-3552'(V0, V1, 'Idris.Prelude':'dn--un--==_Eq__Nat'('Idris.Prelude':'un--length'(V1), 'Idris.Prelude':'dn--un--fromInteger_Num__Nat'(0)));
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--case block in escape\'-3431'(V0, V1, V2, V3) ->
    case V3 of
...
'case--case block in case block in escape\'-3363'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
...
'case--case block in escape\'-3313'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      ...
      {'Idris.Prelude.Nothing'} -> fun () -> 'case--case block in case block in escape\'-3363'(V0, V1, V2, V3, V4, 'un--getEsc'('Idris.Prelude':'un--fastPack'([V1, V2]))) end();
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--escape\'-3281'(V0, V1) ->
    case V1 of
			  ...
			  [E2 | E3] ->
			      fun (V4, V5) ->
					...
					[E4 | E5] ->
					    fun (V6, V7) ->
						    case V7 of
						      [E6 | E7] -> fun (V8, V9) -> 'case--case block in escape\'-3313'(V0, V4, V6, V8, V9, 'un--getEsc'('Idris.Prelude':'un--fastPack'([V4, V6, V8]))) end(E6, E7);
						      [] -> 'case--case block in escape\'-3431'(V0, V4, V6, 'un--getEsc'('Idris.Prelude':'un--fastPack'([V4, V6])));
						      _ -> 'un--escape\''(V3)
						    end
					    end(E4, E5);
					_ -> 'un--escape\''(V3)
...
'case--escape\'-3229'(V0, V1) ->
    case V1 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V2, V3) ->
		  case V2 of
		    [] -> 'un--escape\''(V3);
		    _ -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'nested--4234-3187--in--un--toOct'(V0, 1, 'Idris.Data.List':'un--reverse'(erased, V2)), fun (V4) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'un--escape\''(V3), fun (V5) -> 'Idris.Prelude':'dn--un--pure_Applicative__Maybe'(erased, ['Idris.Prelude':'dn--un--cast_Cast__Int_Char'(V4) | V5]) end) end)
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--escape\'-3137'(V0, V1) ->
    case V1 of
      {'Idris.Builtin.MkPair', E0, E1} ->
	  fun (V2, V3) ->
		  case V2 of
		    [] -> 'un--escape\''(V3);
		    _ -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'nested--4234-3095--in--un--toHex'(V0, 1, 'Idris.Data.List':'un--reverse'(erased, V2)), fun (V4) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'un--escape\''(V3), fun (V5) -> 'Idris.Prelude':'dn--un--pure_Applicative__Maybe'(erased, ['Idris.Prelude':'dn--un--cast_Cast__Int_Char'(V4) | V5]) end) end)
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--4234-3187--in--un--toOct'(V0, V1, V2) ->
    case V2 of
      [] -> {'Idris.Prelude.Just', 0};
      [E0 | E1] -> fun (V3, V4) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'un--oct'('Idris.Prelude':'un--toLower'(V3)), fun (V5) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'nested--4234-3187--in--un--toOct'(V0, V1 * 8 rem 9223372036854775808, V4), fun (V6) -> 'Idris.Prelude':'dn--un--pure_Applicative__Maybe'(erased, (V5 * V1 rem 9223372036854775808 + V6) rem 9223372036854775808) end) end) end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--4234-3095--in--un--toHex'(V0, V1, V2) ->
    case V2 of
      [] -> {'Idris.Prelude.Just', 0};
      [E0 | E1] -> fun (V3, V4) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'un--hex'('Idris.Prelude':'un--toLower'(V3)), fun (V5) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'nested--4234-3095--in--un--toHex'(V0, V1 * 16 rem 9223372036854775808, V4), fun (V6) -> 'Idris.Prelude':'dn--un--pure_Applicative__Maybe'(erased, (V5 * V1 rem 9223372036854775808 + V6) rem 9223372036854775808) end) end) end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
...
'un--getCharLit'(V0) -> 'Idris.Prelude':'dn--un-->>=_Monad__Maybe'(erased, erased, 'un--escape'(V0), fun (V1) -> 'case--getCharLit-3530'(V0, V1, 'Idris.Prelude':'dn--un--==_Eq__Nat'('Idris.Prelude':'un--length'(V1), 'Idris.Prelude':'dn--un--fromInteger_Num__Nat'(1))) end).
			...
			case V2 of
			  [E2 | E3] ->
			      fun (V3, V4) ->
					...
					$x -> 'case--escape\'-3137'(V4, 'Idris.Data.List':'un--span'(erased, fun (V16) -> 'Idris.Prelude':'un--isHexDigit'(V16) end, V4));
					$o -> 'case--escape\'-3229'(V4, 'Idris.Data.List':'un--span'(erased, fun (V17) -> 'Idris.Prelude':'un--isOctDigit'(V17) end, V4));
					_ -> 'case--escape\'-3281'(V2, 'Idris.Data.List':'un--span'(erased, fun (V18) -> 'Idris.Prelude':'un--isDigit'(V18) end, V2))
				      end
			      end(E2, E3);
			  _ -> 'case--escape\'-3281'(V2, 'Idris.Data.List':'un--span'(erased, fun (V19) -> 'Idris.Prelude':'un--isDigit'(V19) end, V2))
			end;
