...
-export(['case--toList,iter-1330'/6, 'case--newArrayCopy-1273'/4, 'case--newArrayCopy,copyFrom-1209'/7, 'case--readArray-1171'/4, 'case--writeArray-1119'/5, 'case--prim__arrayGet-960'/7, 'nested--3254-1320--in--un--iter'/5, 'nested--3126-1197--in--un--copyFrom'/6, 'nested--3321-1382--in--un--addToArray'/5, 'un--writeArray'/4, 'un--toList'/2, 'un--readArray'/3, 'un--prim__newArray'/5, 'un--prim__arraySet'/6, 'un--prim__arrayGet'/5, 'un--newArrayCopy'/3, 'un--newArray'/3, 'un--max'/2, 'un--fromList'/3]).

'case--toList,iter-1330'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      0 -> fun (V6) -> 'Idris.Data.List':'un--reverse'(erased, V2) end;
      1 -> fun (V7) -> begin V8 = ('un--readArray'(erased, V1, V4))(V7), ('nested--3254-1320--in--un--iter'(erased, V1, (V4 + 1) rem 9223372036854775808, V3, [V8 | V2]))(V7) end end;
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case--newArrayCopy-1273'(V0, V1, V2, V3) ->
    case V3 of
      0 -> 'un--max'(erased, V1);
      1 -> V2;
      _ -> erlang:throw("Error: Unreachable branch")
...
'case--writeArray-1119'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--prim__arrayGet-960'(V0, V1, V2, V3, V4, V5, V6) ->
...
'nested--3254-1320--in--un--iter'(V0, V1, V2, V3, V4) -> 'case--toList,iter-1330'(erased, V1, V4, V3, V2, 'Idris.Prelude':'dn--un-->=_Ord__Int'(V2, V3)).

'nested--3126-1197--in--un--copyFrom'(V0, V1, V2, V3, V4, V5) -> 'case--newArrayCopy,copyFrom-1209'(erased, V1, V2, V5, V4, V3, 'Idris.Prelude':'dn--un--<_Ord__Int'(V5, 0)).

'nested--3321-1382--in--un--addToArray'(V0, V1, V2, V3, V4) ->
    case V3 of
      [] -> fun (V5) -> {'Idris.Builtin.MkUnit'} end;
      [E0 | E1] ->
	  fun (V6, V7) ->
		  case V6 of
		    {'Idris.Prelude.Nothing'} -> fun () -> 'nested--3321-1382--in--un--addToArray'(erased, V1, (V2 + 1) rem 9223372036854775808, V7, V4) end();
			...
			fun (V8) ->
				fun (V9) ->
					begin
					  ...
					  ('nested--3321-1382--in--un--addToArray'(erased, V1, (V2 + 1) rem 9223372036854775808, V7, V4))(V9)
					end
				end
			end(E2);
		    _ -> erlang:throw("Error: Unreachable branch")
...
'un--writeArray'(V0, V1, V2, V3) -> 'case--writeArray-1119'(erased, V3, V2, V1, 'Idris.Prelude':'un--||'('Idris.Prelude':'dn--un--<_Ord__Int'(V2, 0), fun () -> 'Idris.Prelude':'dn--un-->=_Ord__Int'(V2, 'un--max'(erased, V1)) end)).

'un--toList'(V0, V1) -> 'nested--3254-1320--in--un--iter'(erased, V1, 0, 'un--max'(erased, V1), []).

'un--readArray'(V0, V1, V2) -> 'case--readArray-1171'(erased, V2, V1, 'Idris.Prelude':'un--||'('Idris.Prelude':'dn--un--<_Ord__Int'(V2, 0), fun () -> 'Idris.Prelude':'dn--un-->=_Ord__Int'(V2, 'un--max'(erased, V1)) end)).
...
'un--newArrayCopy'(V0, V1, V2) ->
    begin
      V3 = 'case--newArrayCopy-1273'(erased, V2, V1, 'Idris.Prelude':'dn--un--<_Ord__Int'(V1, 'un--max'(erased, V2))),
      fun (V4) ->
	      begin
		V5 = 'un--newArray'(erased, V3, V4),
		begin
		  V10 = ('nested--3126-1197--in--un--copyFrom'(erased, V2, V1,
							       case V2 of
...
'un--fromList'(V0, V1, V2) -> begin V3 = 'un--newArray'(erased, 'Idris.Prelude':'dn--un--cast_Cast__Nat_Int'('Idris.Data.List':'un--length'(erased, V1)), V2), begin V4 = ('nested--3321-1382--in--un--addToArray'(erased, V1, 0, V1, V3))(V2), V3 end end.