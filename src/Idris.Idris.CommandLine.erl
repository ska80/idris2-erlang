...
'nested--3302-1677--in--un--showSep'(V0, V1, V2) ->
    case V2 of
      [] -> <<""/utf8>>;
      [E0 | E1] ->
	  fun (V3, V4) ->
		  case V4 of
		    [] -> V3;
		    _ -> 'Idris.Prelude.Strings':'un--++'(V3, 'Idris.Prelude.Strings':'un--++'(V1, 'nested--3302-1677--in--un--showSep'(V0, V1, V4)))
		  end
	  end(E0, E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'nested--2224-621--in--un--portPart'(V0, V1, V2) -> 'case--ideSocketModeAddress,portPart-629'(V0, V1, V2, 'Idris.Prelude':'dn--un--==_Eq__String'(V2, <<""/utf8>>)).

'nested--3302-1679--in--un--optUsage'(V0, V1, V2) ->
    case V2 of
...
'nested--3302-1678--in--un--optShow'(V0, V1) ->
    case V1 of
      {'Idris.Idris.CommandLine.MkOpt', E0, E1, E2, E3} ->
	  fun (V2, V3, V4, V5) ->
		  case V2 of
		    [] -> {'Idris.Builtin.MkPair', <<""/utf8>>, {'Idris.Prelude.Just', <<""/utf8>>}};
		    _ -> {'Idris.Builtin.MkPair', 'Idris.Prelude.Strings':'un--++'('nested--3302-1677--in--un--showSep'(V0, <<", "/utf8>>, V2), 'Idris.Prelude.Strings':'un--++'(<<" "/utf8>>, 'nested--3302-1677--in--un--showSep'(V0, <<" "/utf8>>, 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V6) -> 'dn--un--show_Show__OptType'(V6) end, V3)))), V5}
		  end
	  end(E0, E1, E2, E3);
      _ -> erlang:throw("Error: Unreachable branch")
    end.
...
'un--optsUsage'(V0) ->
    begin
      V2 = 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V1) -> 'nested--3302-1678--in--un--optShow'(V0, V1) end, V0),
      begin
