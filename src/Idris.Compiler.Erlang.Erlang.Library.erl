...
-export(['case--build-3771'/5, 'un--writeErlFiles'/6, 'un--writeBeamFiles'/5, 'un--writeAbstrFiles'/4, 'un--shouldCompileName'/2, 'un--build'/4]).

'case--build-3771'(V0, V1, V2, V3, V4) ->
    case V4 of
