...
-export(['case--condC-5321'/6, 'case--cond-5278'/5, 'case--filterM-5156'/5, 'case--allM-5097'/5, 'case--anyM-5039'/5, 'case--case block in catch-4575'/6, 'case--catch-4561'/4, 'case-->>=-4372'/5, 'case--wrapError-4237'/4, 'case--case block in show-3001'/4, 'case--show-2976'/3, 'case--show-2878'/4, 'case--show-2727'/4, 'nested--5583-3053--in--un--showRig'/5, 'nested--5583-3054--in--un--showRel'/5, 'nested--5583-3618--in--un--showMod'/2, 'dn--un--throw_Catchable__Core_Error'/3, 'dn--un--show_Show__TTCErrorMsg'/1, 'dn--un--show_Show__Error'/1, 'dn--un--show_Show__DotReason'/1, 'dn--un--showPrec_Show__TTCErrorMsg'/2, 'dn--un--showPrec_Show__Error'/2, 'dn--un--showPrec_Show__DotReason'/2, 'dn--un--catch_Catchable__Core_Error'/4, 'dn--un--__Impl_Show_TTCErrorMsg'/0, 'dn--un--__Impl_Show_Error'/0, 'dn--un--__Impl_Show_DotReason'/0, 'dn--un--__Impl_Catchable_Core_Error'/0, 'un--wrapError'/4, 'un--when'/2, 'un--traverse_'/4, 'un--traverseVect'/5, 'un--traverseOpt'/4, 'un--traverse\''/5, 'un--traverse'/4, 'un--throw'/4, 'un--put'/6, 'un--pure'/3, 'un--newRef'/5, 'un--map'/5, 'un--getWarningLoc'/1, 'un--getErrorLoc'/1, 'un--get'/5, 'un--filterM'/3, 'un--coreRun'/6, 'un--coreLift'/3, 'un--coreFail'/3, 'un--condC'/3, 'un--cond'/3, 'un--catch'/4, 'un--anyM'/3, 'un--allM'/3, 'un-->>='/5, 'un--<*>'/5, 'un--<$>'/5]).

'case--condC-5321'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
      0 -> V2;
...
'case--filterM-5156'(V0, V1, V2, V3, V4) ->
    case V4 of
      0 ->
	  fun (V5) ->
		  begin
...
'case--case block in catch-4575'(V0, V1, V2, V3, V4, V5) -> V5.

'case--catch-4561'(V0, V1, V2, V3) ->
    case V3 of
      {'Idris.Prelude.Left', E0} -> fun (V4) -> begin V5 = {'Idris.Prelude.Left', V4}, 'case--case block in catch-4575'(erased, V1, V2, V4, V5, V2(V4)) end end(E0);
      {'Idris.Prelude.Right', E1} -> fun (V6) -> fun (V7) -> {'Idris.Prelude.Right', V6} end end(E1);
      _ -> erlang:throw("Error: Unreachable branch")
    end.

'case-->>=-4372'(V0, V1, V2, V3, V4) ->
    case V4 of
...
'case--wrapError-4237'(V0, V1, V2, V3) ->
    case V3 of
...
'case--case block in show-3001'(V0, V1, V2, V3) ->
    case V2 of
      [E0 | E1] ->
	  fun (V4, V5) ->
		  case V5 of
...
'dn--un--show_Show__Error'(V0) ->
    case V0 of
      ...
      {'Idris.Core.Core.LinearMisuse', E57, E58, E59, E60} -> fun (V61, V62, V63, V64) -> 'Idris.Prelude.Strings':'un--++'('Idris.Core.FC':'dn--un--show_Show__FC'(V61), 'Idris.Prelude.Strings':'un--++'(<<":Trying to use "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--5583-3053--in--un--showRig'(V64, V63, V62, V61, V63), 'Idris.Prelude.Strings':'un--++'(<<" name "/utf8>>, 'Idris.Prelude.Strings':'un--++'('Idris.Core.Name':'dn--un--show_Show__Name'(V62), 'Idris.Prelude.Strings':'un--++'(<<" in "/utf8>>, 'Idris.Prelude.Strings':'un--++'('nested--5583-3054--in--un--showRel'(V64, V63, V62, V61, V64), <<" context"/utf8>>))))))) end(E57, E58, E59, E60);
      ...
      {'Idris.Core.Core.CyclicImports', E193} -> fun (V261) -> 'Idris.Prelude.Strings':'un--++'(<<"Module imports form a cycle: "/utf8>>, 'Idris.Core.Name':'un--showSep'(<<" -> "/utf8>>, 'Idris.Prelude':'dn--un--map_Functor__List'(erased, erased, fun (V262) -> 'nested--5583-3618--in--un--showMod'(V261, V262) end, V261))) end(E193);
...
'dn--un--catch_Catchable__Core_Error'(V0, V1, V2, V3) ->
    begin
      V4 = V1(V3),
      case V4 of
	{'Idris.Prelude.Left', E0} -> fun (V5) -> begin V6 = {'Idris.Prelude.Left', V5}, ('case--case block in catch-4575'(erased, V1, V2, V5, V6, V2(V5)))(V3) end end(E0);
