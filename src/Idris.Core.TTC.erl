...
'case--case block in fromBuf-6963'(V0, V1, V2, V3, V4, V5) ->
    case V5 of
			  ...
			  fun (V6) ->
				  begin
				    ...
				    case V7 of
				      ...
				      {'Idris.Prelude.Right', E3} -> fun (V9) -> begin V10 = 0, ('case--case block in fromBuf-6963'(V0, V1, V10, V6, V9, 'un--getName'(V9, V0)))(V3) end end(E3);
				      _ -> erlang:throw("Error: Unreachable branch")
				    end
				  end
			  end(E1);
...
'case--fromBuf-6376'(V0, V1) ->
    case V1 of
	  ...
	  begin
	    V3 = V1 - 1,
	    case V3 of
	      0 -> fun (V4) -> 'nested--10453-5849--in--un--fromBuf1'(V0, V1, V4) end;
	      _ ->
		  begin
		    V5 = V3 - 1,
		    case V5 of
		      0 -> fun (V6) -> 'nested--10453-5850--in--un--fromBuf2'(V0, V1, V6) end;
		      _ ->
			  begin
			    V7 = V5 - 1,
			    case V7 of
			      0 -> fun (V8) -> 'nested--10453-5851--in--un--fromBuf3'(V0, V1, V8) end;
...
'case--fromBuf,fromBuf3-6348'(V0, V1, V2) ->
    case V2 of
...
'case--fromBuf,fromBuf2-6054'(V0, V1, V2) ->
    case V2 of
      0 ->
	  fun (V3) ->
		  begin
...
'case--fromBuf,fromBuf1-5862'(V0, V1, V2) ->
    case V2 of
      5 ->
	  fun (V3) ->
		  begin
...
'case--case block in fromBuf-3965'(V0, V1, V2, V3, V4, V5, V6) ->
    case V6 of
	  ...
	  fun (V95) ->
		  begin
		    ...
		    case V100 of
		      ...
		      {'Idris.Prelude.Right', E1} -> fun (V102) -> begin V103 = 'Idris.Prelude':'dn--un--fromInteger_Num__Nat'('Idris.Prelude':'dn--un--cast_Cast__Int_Integer'('Idris.Prelude':'dn--un---_Neg__Int'(V2, 12))), begin V104 = V2, ('case--case block in fromBuf-3965'(V0, V1, V2, V104, V102, V103, 'un--getName'(V103, V1)))(V95) end end end(E1);
		      _ -> erlang:throw("Error: Unreachable branch")
		    end
		  end
	  end
...
'case--toBuf-3281'(V0, V1, V2, V3, V4, V5, V6, V7) ->
    case V7 of
      0 ->
	  fun (V8) ->
		  begin
...
'nested--10453-5851--in--un--fromBuf3'(V0, V1, V2) ->
    begin
...
'nested--10453-5850--in--un--fromBuf2'(V0, V1, V2) ->
    begin
      V3 = 'Idris.Utils.Binary':'un--getTag'(V0, V2),
      case V3 of
	{'Idris.Prelude.Left', E0} -> fun (V4) -> {'Idris.Prelude.Left', V4} end(E0);
...
'nested--10453-5849--in--un--fromBuf1'(V0, V1, V2) ->
    begin
      V3 = 'Idris.Utils.Binary':'un--getTag'(V0, V2),
      case V3 of
	{'Idris.Prelude.Left', E0} -> fun (V4) -> {'Idris.Prelude.Left', V4} end(E0);
...
'nested--14512-9622--in--un--cwName'(V0, V1, V2) ->
    case V2 of
													...
													{'Idris.Prelude.Right', E160} ->
													    fun (V266) ->
														    case 'Idris.Prelude':'un--||'('Idris.Core.Name':'un--isUserName'(case V1 of
																		  ...
																		  fun () ->
																			  'nested--14512-9622--in--un--cwName'(V1, V0,
																							       case V1 of
...
'dn--un--toBuf_TTC__(Term $vars)'(V0, V1, V2) ->
    case V2 of
      {'Idris.Core.TT.Local', E0, E1, E2} -> fun (V3, V4, V5) -> 'case--toBuf-3281'(V0, V5, erased, erased, V4, V3, V1, 'Idris.Prelude':'dn--un--<_Ord__Nat'(V5, 'Idris.Prelude':'dn--un--fromInteger_Num__Nat'(244))) end(E0, E1, E2);
											      ...
											      fun (V115) ->
													...
													begin
													  ...
													  case V118 of
													    ...
													    {'Idris.Prelude.Right', E13} -> fun (V120) -> ('case--fromBuf-9887'(V0, V8, V56, V58, V61, V64, V67, V115, V117, V120, 'Idris.Core.Name':'un--isUserName'(V67)))(V1) end(E13);
													    _ -> erlang:throw("Error: Unreachable branch")
													  end
													end
												      end
		    ...
		    case V5 of
			  ...
			  begin
			    ...
			    case V90 of
			      ...
			      {'Idris.Prelude.Right', E3} -> fun (V92) -> begin V93 = 'Idris.Prelude':'dn--un--fromInteger_Num__Nat'('Idris.Prelude':'dn--un--cast_Cast__Int_Integer'('Idris.Prelude':'dn--un---_Neg__Int'(V5, 12))), begin V94 = V5, ('case--case block in fromBuf-3965'(V1, V0, V5, V94, V92, V93, 'un--getName'(V93, V0)))(V2) end end end(E3);
			      _ -> erlang:throw("Error: Unreachable branch")
			    end
			  end
		    end
...
'dn--un--fromBuf_TTC__(PrimFn $n)'(V0, V1) ->
    case V0 of
	  ...
	  begin
	    V3 = V0 - 1,
	    case V3 of
	      0 -> fun (V4) -> 'nested--10453-5849--in--un--fromBuf1'(V1, V0, V4) end;
	      _ ->
		  begin
		    V5 = V3 - 1,
		    case V5 of
		      0 -> fun (V6) -> 'nested--10453-5850--in--un--fromBuf2'(V1, V0, V6) end;
		      _ ->
			  begin
			    V7 = V5 - 1,
			    case V7 of
			      0 -> fun (V8) -> 'nested--10453-5851--in--un--fromBuf3'(V1, V0, V8) end;
			      _ -> fun (V9) -> 'Idris.Utils.Binary':'un--corrupt'(erased, <<"PrimFn"/utf8>>, V9) end
			    end
			  end
		    end
			    ...
			    case V6 of
				  ...
				  fun (V8) ->
					  begin
					    ...
					    case V9 of
					      {'Idris.Prelude.Left', E4} -> fun (V10) -> {'Idris.Prelude.Left', V10} end(E4);
					      {'Idris.Prelude.Right', E5} -> fun (V11) -> begin V12 = 0, ('case--case block in fromBuf-6963'(V0, V1, V12, V8, V11, 'un--getName'(V11, V0)))(V2) end end(E5);
					      _ -> erlang:throw("Error: Unreachable branch")
					    end
					  end
				  end(E3);
